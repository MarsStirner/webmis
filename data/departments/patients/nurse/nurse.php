...
echo $callback_name ?>(
	{
    	...
    	data:   [  {
    		...
    		condition:   {
    			state:   {
    				id: 1552452,
    				name: "тяжелое по основному заболеванию"
    			},
    			breathingRate: "",
    	...
    	  {
    		...
    		condition:   {
    			state:   {
    				id: 1553658,
    				name: "тяжелое по основному заболеванию,стабильное. Сон спокойный. Аппетит не нарушен. Активно питается, прибавляет в весе. Разовый объем кормления усваивает, срыгивания рвоты нет."
    			},
    			breathingRate: "",
    			arterialBloodPressure: ""
    		}
    	...
    	  {
    		...
    		condition:   {
    			state:   {
    				id: 1553452,
    				name: "тяжелое по заболеванию, стабильное."
    			},
    			breathingRate: "",
    			arterialBloodPressure: ""
    		}
