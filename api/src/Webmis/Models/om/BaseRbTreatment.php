...
/**
 * Base class that represents a row from the 'rbTreatment' table.
 *
 *
 *
 * @package    propel.generator.Models.om
 */
abstract class BaseRbTreatment extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbTreatmentPeer';
     ...
     * @return RbTreatment The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbTreatmentPeer::ID;
        }
    ...
    public function setcode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = RbTreatmentPeer::CODE;
        }
    ...
    public function setname($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbTreatmentPeer::NAME;
        }
    ...
    public function setPacientModelId($v)
    {
        ...
        if ($this->pacientmodel_id !== $v) {
            ...
            $this->modifiedColumns[] = RbTreatmentPeer::PACIENTMODEL_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->pacientmodel_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = RbTreatmentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RbTreatment object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbTreatmentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbTreatmentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbTreatmentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbTreatmentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbTreatmentPeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(RbTreatmentPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(RbTreatmentPeer::PACIENTMODEL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`pacientModel_id`';
        }

        $sql = sprintf(
            'INSERT INTO `rbTreatment` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbTreatmentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbTreatmentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['RbTreatment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RbTreatment'][$this->getPrimaryKey()] = true;
        $keys = RbTreatmentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            $keys[1] => $this->getcode(),
            $keys[2] => $this->getname(),
            $keys[3] => $this->getPacientModelId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setPacientModelId($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbTreatmentPeer::ID)) $criteria->add(RbTreatmentPeer::ID, $this->id);
        if ($this->isColumnModified(RbTreatmentPeer::CODE)) $criteria->add(RbTreatmentPeer::CODE, $this->code);
        if ($this->isColumnModified(RbTreatmentPeer::NAME)) $criteria->add(RbTreatmentPeer::NAME, $this->name);
        if ($this->isColumnModified(RbTreatmentPeer::PACIENTMODEL_ID)) $criteria->add(RbTreatmentPeer::PACIENTMODEL_ID, $this->pacientmodel_id);
    ...
    {
        $criteria = new Criteria(RbTreatmentPeer::DATABASE_NAME);
        $criteria->add(RbTreatmentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of RbTreatment (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RbTreatment Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbTreatmentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbTreatmentPeer();
        }
    ...
    public function getRbPacientModel(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRbPacientModel === null && ($this->pacientmodel_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aRbPacientModel->addRbTreatments($this);
             */
        }
     ...
     * If this RbTreatment is new, it will return
    ...
    public function setClientQuotings(PropelCollection $clientQuotings, PropelPDO $con = null)
    {
        ...
        foreach ($clientQuotingsToDelete as $clientQuotingRemoved) {
            $clientQuotingRemoved->setRbTreatment(null);
        }
    ...
    protected function doAddClientQuoting($clientQuoting)
    {
        ...
        $clientQuoting->setRbTreatment($this);
    }
    ...
    public function removeClientQuoting($clientQuoting)
    {
        if ($this->getClientQuotings()->contains($clientQuoting)) {
            ...
            $clientQuoting->setRbTreatment(null);
        }
     ...
     * Otherwise if this RbTreatment is new, it will return
     * an empty collection; or if this RbTreatment has previously
     * been saved, it will retrieve related ClientQuotings from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RbTreatment.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(RbTreatmentPeer::DEFAULT_STRING_FORMAT);
    }
