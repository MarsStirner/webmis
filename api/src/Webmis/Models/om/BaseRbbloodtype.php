...
/**
 * Base class that represents a row from the 'rbBloodType' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseRbbloodtype extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbbloodtypePeer';
     ...
     * @return Rbbloodtype The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbbloodtypePeer::ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = RbbloodtypePeer::CODE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbbloodtypePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = RbbloodtypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Rbbloodtype object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbbloodtypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbbloodtypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbbloodtypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbbloodtypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbbloodtypePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(RbbloodtypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `rbBloodType` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbbloodtypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbbloodtypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Rbbloodtype'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Rbbloodtype'][$this->getPrimaryKey()] = true;
        $keys = RbbloodtypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
            $keys[2] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbbloodtypePeer::ID)) $criteria->add(RbbloodtypePeer::ID, $this->id);
        if ($this->isColumnModified(RbbloodtypePeer::CODE)) $criteria->add(RbbloodtypePeer::CODE, $this->code);
        if ($this->isColumnModified(RbbloodtypePeer::NAME)) $criteria->add(RbbloodtypePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(RbbloodtypePeer::DATABASE_NAME);
        $criteria->add(RbbloodtypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Rbbloodtype (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Rbbloodtype Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbbloodtypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbbloodtypePeer();
        }
     ...
     * If this Rbbloodtype is new, it will return
    ...
    public function setTrfuorderissueresults(PropelCollection $trfuorderissueresults, PropelPDO $con = null)
    {
        ...
        foreach ($trfuorderissueresultsToDelete as $trfuorderissueresultRemoved) {
            $trfuorderissueresultRemoved->setRbbloodtype(null);
        }
    ...
    protected function doAddTrfuorderissueresult($trfuorderissueresult)
    {
        ...
        $trfuorderissueresult->setRbbloodtype($this);
    }
    ...
    public function removeTrfuorderissueresult($trfuorderissueresult)
    {
        if ($this->getTrfuorderissueresults()->contains($trfuorderissueresult)) {
            ...
            $trfuorderissueresult->setRbbloodtype(null);
        }
     ...
     * Otherwise if this Rbbloodtype is new, it will return
     * an empty collection; or if this Rbbloodtype has previously
     * been saved, it will retrieve related Trfuorderissueresults from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Rbbloodtype.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(RbbloodtypePeer::DEFAULT_STRING_FORMAT);
    }
