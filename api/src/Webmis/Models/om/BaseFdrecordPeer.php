...
abstract class BaseFdrecordPeer
{
    ...
    public static function doCountJoinFlatdirectoryRelatedByFlatdirectoryId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(FdrecordPeer::FLATDIRECTORY_ID, FlatdirectoryPeer::ID, $join_behavior);
    ...
    public static function doCountJoinFlatdirectoryRelatedByFlatdirectoryCode(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(FdrecordPeer::FLATDIRECTORY_CODE, FlatdirectoryPeer::CODE, $join_behavior);
    ...
    /**
     * Selects a collection of Fdrecord objects pre-filled with their Flatdirectory objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinFlatdirectoryRelatedByFlatdirectoryId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Fdrecord) to $obj2 (Flatdirectory)
                $obj2->addFdrecordRelatedByFlatdirectoryId($obj1);
    ...
    public static function doSelectJoinFlatdirectoryRelatedByFlatdirectoryCode(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Fdrecord) to $obj2 (Flatdirectory)
                $obj2->addFdrecordRelatedByFlatdirectoryCode($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Fdrecord) to the collection in $obj2 (Flatdirectory)
                $obj2->addFdrecordRelatedByFlatdirectoryId($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Fdrecord) to the collection in $obj3 (Flatdirectory)
                $obj3->addFdrecordRelatedByFlatdirectoryCode($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Fdrecord objects pre-filled with all related objects except FlatdirectoryRelatedByFlatdirectoryId.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Fdrecord objects pre-filled with all related objects except FlatdirectoryRelatedByFlatdirectoryCode.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
