...
/**
 * Base class that represents a row from the 'rbJobType' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseRbjobtype extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbjobtypePeer';
    ...
    /**
     * The value for the laboratory_id field.
     * @var        int
     */
    protected $laboratory_id;

    /**
     * The value for the isinstant field.
    ...
    /**
     * Initializes internal state of BaseRbjobtype object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [laboratory_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [isinstant] column value.
     *
     * @return boolean
     */
     ...
     * @return Rbjobtype The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbjobtypePeer::ID;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[] = RbjobtypePeer::GROUP_ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = RbjobtypePeer::CODE;
        }
    ...
    public function setRegionalcode($v)
    {
        ...
        if ($this->regionalcode !== $v) {
            $this->regionalcode = $v;
            $this->modifiedColumns[] = RbjobtypePeer::REGIONALCODE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbjobtypePeer::NAME;
        }
    ...
    /**
     * Set the value of [laboratory_id] column.
     *
     * @param int $v new value
     * @return Rbjobtype The current object (for fluent API support)
     */
    public function setLaboratoryId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->laboratory_id !== $v) {
            $this->laboratory_id = $v;
            $this->modifiedColumns[] = RbjobtypePeer::LABORATORY_ID;
        }
    ...
    /**
     * Sets the value of the [isinstant] column.
     ...
     * @return Rbjobtype The current object (for fluent API support)
     */
    public function setIsinstant($v)
    {
        if ($v !== null) {
            if (is_string($v)) {
        ...
        if ($this->isinstant !== $v) {
            $this->isinstant = $v;
            $this->modifiedColumns[] = RbjobtypePeer::ISINSTANT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->laboratory_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->isinstant = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = RbjobtypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Rbjobtype object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbjobtypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbjobtypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbjobtypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbjobtypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbjobtypePeer::GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`group_id`';
        }
        if ($this->isColumnModified(RbjobtypePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(RbjobtypePeer::REGIONALCODE)) {
            $modifiedColumns[':p' . $index++]  = '`regionalCode`';
        }
        if ($this->isColumnModified(RbjobtypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(RbjobtypePeer::LABORATORY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`laboratory_id`';
        }
        if ($this->isColumnModified(RbjobtypePeer::ISINSTANT)) {
            $modifiedColumns[':p' . $index++]  = '`isInstant`';
        }

        $sql = sprintf(
            'INSERT INTO `rbJobType` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`name`':
                        ...
                        break;
                    case '`laboratory_id`':
                        $stmt->bindValue($identifier, $this->laboratory_id, PDO::PARAM_INT);
                        break;
                    case '`isInstant`':
                        $stmt->bindValue($identifier, (int) $this->isinstant, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbjobtypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbjobtypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                return $this->getLaboratoryId();
                break;
            case 6:
                return $this->getIsinstant();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Rbjobtype'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Rbjobtype'][$this->getPrimaryKey()] = true;
        $keys = RbjobtypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[4] => $this->getName(),
            $keys[5] => $this->getLaboratoryId(),
            $keys[6] => $this->getIsinstant(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                $this->setLaboratoryId($value);
                break;
            case 6:
                $this->setIsinstant($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setLaboratoryId($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setIsinstant($arr[$keys[6]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbjobtypePeer::ID)) $criteria->add(RbjobtypePeer::ID, $this->id);
        if ($this->isColumnModified(RbjobtypePeer::GROUP_ID)) $criteria->add(RbjobtypePeer::GROUP_ID, $this->group_id);
        if ($this->isColumnModified(RbjobtypePeer::CODE)) $criteria->add(RbjobtypePeer::CODE, $this->code);
        if ($this->isColumnModified(RbjobtypePeer::REGIONALCODE)) $criteria->add(RbjobtypePeer::REGIONALCODE, $this->regionalcode);
        if ($this->isColumnModified(RbjobtypePeer::NAME)) $criteria->add(RbjobtypePeer::NAME, $this->name);
        if ($this->isColumnModified(RbjobtypePeer::LABORATORY_ID)) $criteria->add(RbjobtypePeer::LABORATORY_ID, $this->laboratory_id);
        if ($this->isColumnModified(RbjobtypePeer::ISINSTANT)) $criteria->add(RbjobtypePeer::ISINSTANT, $this->isinstant);
    ...
    {
        $criteria = new Criteria(RbjobtypePeer::DATABASE_NAME);
        $criteria->add(RbjobtypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Rbjobtype (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLaboratoryId($this->getLaboratoryId());
        $copyObj->setIsinstant($this->getIsinstant());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Rbjobtype Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbjobtypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbjobtypePeer();
        }
     ...
     * If this Rbjobtype is new, it will return
    ...
    public function setActiontypes(PropelCollection $actiontypes, PropelPDO $con = null)
    {
        ...
        foreach ($actiontypesToDelete as $actiontypeRemoved) {
            $actiontypeRemoved->setRbjobtype(null);
        }
     ...
     * Otherwise if this Rbjobtype is new, it will return
     * an empty collection; or if this Rbjobtype has previously
     * been saved, it will retrieve related Actiontypes from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Rbjobtype.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Actiontype[] List of Actiontype objects
     */
    public function getActiontypesJoinPerson($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ActiontypeQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(RbjobtypePeer::DEFAULT_STRING_FORMAT);
    }
