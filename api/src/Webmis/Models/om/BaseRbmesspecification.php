...
/**
 * Base class that represents a row from the 'rbMesSpecification' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseRbmesspecification extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbmesspecificationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RbmesspecificationPeer
     */
     ...
     * @return Rbmesspecification The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbmesspecificationPeer::ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = RbmesspecificationPeer::CODE;
        }
    ...
    public function setRegionalcode($v)
    {
        ...
        if ($this->regionalcode !== $v) {
            $this->regionalcode = $v;
            $this->modifiedColumns[] = RbmesspecificationPeer::REGIONALCODE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbmesspecificationPeer::NAME;
        }
    ...
    public function setDone($v)
    {
        ...
        if ($this->done !== $v) {
            $this->done = $v;
            $this->modifiedColumns[] = RbmesspecificationPeer::DONE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->done = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = RbmesspecificationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Rbmesspecification object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbmesspecificationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbmesspecificationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbmesspecificationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbmesspecificationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbmesspecificationPeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(RbmesspecificationPeer::REGIONALCODE)) {
            $modifiedColumns[':p' . $index++]  = '`regionalCode`';
        }
        if ($this->isColumnModified(RbmesspecificationPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(RbmesspecificationPeer::DONE)) {
            $modifiedColumns[':p' . $index++]  = '`done`';
        }

        $sql = sprintf(
            'INSERT INTO `rbMesSpecification` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbmesspecificationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbmesspecificationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Rbmesspecification'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Rbmesspecification'][$this->getPrimaryKey()] = true;
        $keys = RbmesspecificationPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setDone($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbmesspecificationPeer::ID)) $criteria->add(RbmesspecificationPeer::ID, $this->id);
        if ($this->isColumnModified(RbmesspecificationPeer::CODE)) $criteria->add(RbmesspecificationPeer::CODE, $this->code);
        if ($this->isColumnModified(RbmesspecificationPeer::REGIONALCODE)) $criteria->add(RbmesspecificationPeer::REGIONALCODE, $this->regionalcode);
        if ($this->isColumnModified(RbmesspecificationPeer::NAME)) $criteria->add(RbmesspecificationPeer::NAME, $this->name);
        if ($this->isColumnModified(RbmesspecificationPeer::DONE)) $criteria->add(RbmesspecificationPeer::DONE, $this->done);
    ...
    {
        $criteria = new Criteria(RbmesspecificationPeer::DATABASE_NAME);
        $criteria->add(RbmesspecificationPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Rbmesspecification (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Rbmesspecification Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbmesspecificationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbmesspecificationPeer();
        }
     ...
     * If this Rbmesspecification is new, it will return
        ...
        if (null === $this->collEvents || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collEvents) {
                ...
                $collEvents = EventQuery::create(null, $criteria)
                    ->filterByRbmesspecification($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setEvents(PropelCollection $events, PropelPDO $con = null)
    {
        ...
        foreach ($eventsToDelete as $eventRemoved) {
            $eventRemoved->setRbmesspecification(null);
        }
    ...
    protected function doAddEvent($event)
    {
        ...
        $event->setRbmesspecification($this);
    }
    ...
    public function removeEvent($event)
    {
        if ($this->getEvents()->contains($event)) {
            ...
            $event->setRbmesspecification(null);
        }
     ...
     * Otherwise if this Rbmesspecification is new, it will return
     * an empty collection; or if this Rbmesspecification has previously
     * been saved, it will retrieve related Events from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Rbmesspecification.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Event[] List of Event objects
     */
    public function getEventsJoinRbacheresult($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = EventQuery::create(null, $criteria);
        $query->joinWith('Rbacheresult', $join_behavior);
    ...
    {
        return (string) $this->exportTo(RbmesspecificationPeer::DEFAULT_STRING_FORMAT);
    }
