...
abstract class BaseMeta extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\MetaPeer';
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = MetaPeer::NAME;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = MetaPeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = MetaPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MetaPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(MetaPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }

        $sql = sprintf(
            'INSERT INTO `Meta` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Meta'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Meta'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MetaPeer::NAME)) $criteria->add(MetaPeer::NAME, $this->name);
        if ($this->isColumnModified(MetaPeer::VALUE)) $criteria->add(MetaPeer::VALUE, $this->value);
    ...
    {
        $criteria = new Criteria(MetaPeer::DATABASE_NAME);
        $criteria->add(MetaPeer::NAME, $this->name);
    ...
    {
        return (string) $this->exportTo(MetaPeer::DEFAULT_STRING_FORMAT);
    }
