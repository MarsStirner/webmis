...
/**
 * Base class that represents a row from the 'ClientDocument' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseClientdocument extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ClientdocumentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ClientdocumentPeer
     */
    ...
    /**
     * Initializes internal state of BaseClientdocument object.
     * @see        applyDefaults()
     */
     ...
     * @return Clientdocument The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ClientdocumentPeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientdocumentPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientdocumentPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientdocumentPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientdocumentPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = ClientdocumentPeer::DELETED;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = ClientdocumentPeer::CLIENT_ID;
        }
    ...
    public function setDocumenttypeId($v)
    {
        ...
        if ($this->documenttype_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientdocumentPeer::DOCUMENTTYPE_ID;
        }
    ...
    public function setSerial($v)
    {
        ...
        if ($this->serial !== $v) {
            $this->serial = $v;
            $this->modifiedColumns[] = ClientdocumentPeer::SERIAL;
        }
    ...
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[] = ClientdocumentPeer::NUMBER;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientdocumentPeer::DATE;
            }
        } // if either are not null
    ...
    public function setOrigin($v)
    {
        ...
        if ($this->origin !== $v) {
            $this->origin = $v;
            $this->modifiedColumns[] = ClientdocumentPeer::ORIGIN;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = ClientdocumentPeer::VERSION;
        }
    ...
    public function setEnddate($v)
    {
        ...
        if ($this->enddate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientdocumentPeer::ENDDATE;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 14; // 14 = ClientdocumentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Clientdocument object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ClientdocumentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ClientdocumentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ClientdocumentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClientdocumentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::DOCUMENTTYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`documentType_id`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::SERIAL)) {
            $modifiedColumns[':p' . $index++]  = '`serial`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::NUMBER)) {
            $modifiedColumns[':p' . $index++]  = '`number`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::ORIGIN)) {
            $modifiedColumns[':p' . $index++]  = '`origin`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`version`';
        }
        if ($this->isColumnModified(ClientdocumentPeer::ENDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`endDate`';
        }

        $sql = sprintf(
            'INSERT INTO `ClientDocument` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ClientdocumentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ClientdocumentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Clientdocument'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Clientdocument'][$this->getPrimaryKey()] = true;
        $keys = ClientdocumentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientdocumentPeer::ID)) $criteria->add(ClientdocumentPeer::ID, $this->id);
        if ($this->isColumnModified(ClientdocumentPeer::CREATEDATETIME)) $criteria->add(ClientdocumentPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(ClientdocumentPeer::CREATEPERSON_ID)) $criteria->add(ClientdocumentPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(ClientdocumentPeer::MODIFYDATETIME)) $criteria->add(ClientdocumentPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(ClientdocumentPeer::MODIFYPERSON_ID)) $criteria->add(ClientdocumentPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(ClientdocumentPeer::DELETED)) $criteria->add(ClientdocumentPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(ClientdocumentPeer::CLIENT_ID)) $criteria->add(ClientdocumentPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(ClientdocumentPeer::DOCUMENTTYPE_ID)) $criteria->add(ClientdocumentPeer::DOCUMENTTYPE_ID, $this->documenttype_id);
        if ($this->isColumnModified(ClientdocumentPeer::SERIAL)) $criteria->add(ClientdocumentPeer::SERIAL, $this->serial);
        if ($this->isColumnModified(ClientdocumentPeer::NUMBER)) $criteria->add(ClientdocumentPeer::NUMBER, $this->number);
        if ($this->isColumnModified(ClientdocumentPeer::DATE)) $criteria->add(ClientdocumentPeer::DATE, $this->date);
        if ($this->isColumnModified(ClientdocumentPeer::ORIGIN)) $criteria->add(ClientdocumentPeer::ORIGIN, $this->origin);
        if ($this->isColumnModified(ClientdocumentPeer::VERSION)) $criteria->add(ClientdocumentPeer::VERSION, $this->version);
        if ($this->isColumnModified(ClientdocumentPeer::ENDDATE)) $criteria->add(ClientdocumentPeer::ENDDATE, $this->enddate);
    ...
    {
        $criteria = new Criteria(ClientdocumentPeer::DATABASE_NAME);
        $criteria->add(ClientdocumentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Clientdocument (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Clientdocument Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ClientdocumentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ClientdocumentPeer();
        }
    ...
    {
        return (string) $this->exportTo(ClientdocumentPeer::DEFAULT_STRING_FORMAT);
    }
