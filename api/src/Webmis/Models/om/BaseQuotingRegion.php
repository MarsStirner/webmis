...
/**
 * Base class that represents a row from the 'Quoting_Region' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseQuotingRegion extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\QuotingRegionPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        QuotingRegionPeer
     */
    ...
    /**
     * The value for the region_code field.
     * @var        string
     */
    ...
    /**
     * Initializes internal state of BaseQuotingRegion object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [region_code] column value.
     *
     * @return string
     */
     ...
     * @return QuotingRegion The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = QuotingRegionPeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = QuotingRegionPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = QuotingRegionPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = QuotingRegionPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = QuotingRegionPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = QuotingRegionPeer::DELETED;
        }
    ...
    public function setMasterId($v)
    {
        ...
        if ($this->master_id !== $v) {
            $this->master_id = $v;
            $this->modifiedColumns[] = QuotingRegionPeer::MASTER_ID;
        }
    ...
    /**
     * Set the value of [region_code] column.
     *
    ...
    public function setRegionCode($v)
    {
        ...
        if ($this->region_code !== $v) {
            $this->region_code = $v;
            $this->modifiedColumns[] = QuotingRegionPeer::REGION_CODE;
        }
    ...
    public function setLimitation($v)
    {
        ...
        if ($this->limitation !== $v) {
            $this->limitation = $v;
            $this->modifiedColumns[] = QuotingRegionPeer::LIMITATION;
        }
    ...
    public function setUsed($v)
    {
        ...
        if ($this->used !== $v) {
            $this->used = $v;
            $this->modifiedColumns[] = QuotingRegionPeer::USED;
        }
    ...
    public function setConfirmed($v)
    {
        ...
        if ($this->confirmed !== $v) {
            $this->confirmed = $v;
            $this->modifiedColumns[] = QuotingRegionPeer::CONFIRMED;
        }
    ...
    public function setInqueue($v)
    {
        ...
        if ($this->inqueue !== $v) {
            $this->inqueue = $v;
            $this->modifiedColumns[] = QuotingRegionPeer::INQUEUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->region_code = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->limitation = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            $this->used = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
            $this->confirmed = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
            $this->inqueue = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
            $this->resetModified();
            ...
            return $startcol + 12; // 12 = QuotingRegionPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating QuotingRegion object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = QuotingRegionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = QuotingRegionQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                QuotingRegionPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(QuotingRegionPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::MASTER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`master_id`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::REGION_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`region_code`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::LIMITATION)) {
            $modifiedColumns[':p' . $index++]  = '`limitation`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::USED)) {
            $modifiedColumns[':p' . $index++]  = '`used`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::CONFIRMED)) {
            $modifiedColumns[':p' . $index++]  = '`confirmed`';
        }
        if ($this->isColumnModified(QuotingRegionPeer::INQUEUE)) {
            $modifiedColumns[':p' . $index++]  = '`inQueue`';
        }

        $sql = sprintf(
            'INSERT INTO `Quoting_Region` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`master_id`':
                        ...
                        break;
                    case '`region_code`':
                        $stmt->bindValue($identifier, $this->region_code, PDO::PARAM_STR);
                        break;
                    case '`limitation`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = QuotingRegionPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = QuotingRegionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['QuotingRegion'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['QuotingRegion'][$this->getPrimaryKey()] = true;
        $keys = QuotingRegionPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[7] => $this->getRegionCode(),
            $keys[8] => $this->getLimitation(),
            $keys[9] => $this->getUsed(),
            $keys[10] => $this->getConfirmed(),
            $keys[11] => $this->getInqueue(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setRegionCode($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setLimitation($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setUsed($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setConfirmed($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setInqueue($arr[$keys[11]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuotingRegionPeer::ID)) $criteria->add(QuotingRegionPeer::ID, $this->id);
        if ($this->isColumnModified(QuotingRegionPeer::CREATEDATETIME)) $criteria->add(QuotingRegionPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(QuotingRegionPeer::CREATEPERSON_ID)) $criteria->add(QuotingRegionPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(QuotingRegionPeer::MODIFYDATETIME)) $criteria->add(QuotingRegionPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(QuotingRegionPeer::MODIFYPERSON_ID)) $criteria->add(QuotingRegionPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(QuotingRegionPeer::DELETED)) $criteria->add(QuotingRegionPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(QuotingRegionPeer::MASTER_ID)) $criteria->add(QuotingRegionPeer::MASTER_ID, $this->master_id);
        if ($this->isColumnModified(QuotingRegionPeer::REGION_CODE)) $criteria->add(QuotingRegionPeer::REGION_CODE, $this->region_code);
        if ($this->isColumnModified(QuotingRegionPeer::LIMITATION)) $criteria->add(QuotingRegionPeer::LIMITATION, $this->limitation);
        if ($this->isColumnModified(QuotingRegionPeer::USED)) $criteria->add(QuotingRegionPeer::USED, $this->used);
        if ($this->isColumnModified(QuotingRegionPeer::CONFIRMED)) $criteria->add(QuotingRegionPeer::CONFIRMED, $this->confirmed);
        if ($this->isColumnModified(QuotingRegionPeer::INQUEUE)) $criteria->add(QuotingRegionPeer::INQUEUE, $this->inqueue);
    ...
    {
        $criteria = new Criteria(QuotingRegionPeer::DATABASE_NAME);
        $criteria->add(QuotingRegionPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of QuotingRegion (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return QuotingRegion Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return QuotingRegionPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new QuotingRegionPeer();
        }
    ...
    {
        return (string) $this->exportTo(QuotingRegionPeer::DEFAULT_STRING_FORMAT);
    }
