...
use Webmis\Models\map\AddressTableMap;
...
abstract class BaseAddressPeer
{
    ...
    const OM_CLASS = 'Webmis\\Models\\Address';
    ...
    const CREATEDATETIME = 'Address.createDatetime';

    /** the column name for the createPerson_id field */
    const CREATEPERSON_ID = 'Address.createPerson_id';

    /** the column name for the modifyDatetime field */
    const MODIFYDATETIME = 'Address.modifyDatetime';

    /** the column name for the modifyPerson_id field */
    const MODIFYPERSON_ID = 'Address.modifyPerson_id';

    /** the column name for the deleted field */
    const DELETED = 'Address.deleted';

    /** the column name for the house_id field */
    const HOUSE_ID = 'Address.house_id';

    /** the column name for the flat field */
    const FLAT = 'Address.flat';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Createdatetime', 'CreatepersonId', 'Modifydatetime', 'ModifypersonId', 'Deleted', 'HouseId', 'Flat', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdatetime', 'createpersonId', 'modifydatetime', 'modifypersonId', 'deleted', 'houseId', 'flat', ),
        BasePeer::TYPE_COLNAME => array (AddressPeer::ID, AddressPeer::CREATEDATETIME, AddressPeer::CREATEPERSON_ID, AddressPeer::MODIFYDATETIME, AddressPeer::MODIFYPERSON_ID, AddressPeer::DELETED, AddressPeer::HOUSE_ID, AddressPeer::FLAT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CREATEDATETIME', 'CREATEPERSON_ID', 'MODIFYDATETIME', 'MODIFYPERSON_ID', 'DELETED', 'HOUSE_ID', 'FLAT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'createDatetime', 'createPerson_id', 'modifyDatetime', 'modifyPerson_id', 'deleted', 'house_id', 'flat', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Createdatetime' => 1, 'CreatepersonId' => 2, 'Modifydatetime' => 3, 'ModifypersonId' => 4, 'Deleted' => 5, 'HouseId' => 6, 'Flat' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdatetime' => 1, 'createpersonId' => 2, 'modifydatetime' => 3, 'modifypersonId' => 4, 'deleted' => 5, 'houseId' => 6, 'flat' => 7, ),
        BasePeer::TYPE_COLNAME => array (AddressPeer::ID => 0, AddressPeer::CREATEDATETIME => 1, AddressPeer::CREATEPERSON_ID => 2, AddressPeer::MODIFYDATETIME => 3, AddressPeer::MODIFYPERSON_ID => 4, AddressPeer::DELETED => 5, AddressPeer::HOUSE_ID => 6, AddressPeer::FLAT => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CREATEDATETIME' => 1, 'CREATEPERSON_ID' => 2, 'MODIFYDATETIME' => 3, 'MODIFYPERSON_ID' => 4, 'DELETED' => 5, 'HOUSE_ID' => 6, 'FLAT' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'createDatetime' => 1, 'createPerson_id' => 2, 'modifyDatetime' => 3, 'modifyPerson_id' => 4, 'deleted' => 5, 'house_id' => 6, 'flat' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AddressPeer::CREATEDATETIME);
            $criteria->addSelectColumn(AddressPeer::CREATEPERSON_ID);
            $criteria->addSelectColumn(AddressPeer::MODIFYDATETIME);
            $criteria->addSelectColumn(AddressPeer::MODIFYPERSON_ID);
            $criteria->addSelectColumn(AddressPeer::DELETED);
            $criteria->addSelectColumn(AddressPeer::HOUSE_ID);
            $criteria->addSelectColumn(AddressPeer::FLAT);
        } else {
