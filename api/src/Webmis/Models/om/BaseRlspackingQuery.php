 ...
 * @method RlspackingQuery orderByDisabledforprescription($order = Criteria::ASC) Order by the disabledForPrescription column
 *
 * @method RlspackingQuery groupById() Group by the id column
 * @method RlspackingQuery groupByName() Group by the name column
 * @method RlspackingQuery groupByDisabledforprescription() Group by the disabledForPrescription column
 *
 ...
 * @method Rlspacking findOneByDisabledforprescription(boolean $disabledForPrescription) Return the first Rlspacking filtered by the disabledForPrescription column
 *
 ...
 * @method array findByDisabledforprescription(boolean $disabledForPrescription) Return Rlspacking objects filtered by the disabledForPrescription column
 *
...
abstract class BaseRlspackingQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `name`, `disabledForPrescription` FROM `rlsPacking` WHERE `id` = :p0';
        try {
    ...
    public function filterByDisabledforprescription($disabledforprescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RlspackingPeer::DISABLEDFORPRESCRIPTION, $disabledforprescription, $comparison);
    }
