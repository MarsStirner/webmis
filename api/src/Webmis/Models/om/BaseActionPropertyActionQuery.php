 ...
 *
 * @method ActionPropertyActionQuery leftJoinActionProperty($relationAlias = null) Adds a LEFT JOIN clause to the query using the ActionProperty relation
 * @method ActionPropertyActionQuery rightJoinActionProperty($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ActionProperty relation
 * @method ActionPropertyActionQuery innerJoinActionProperty($relationAlias = null) Adds a INNER JOIN clause to the query using the ActionProperty relation
 *
...
abstract class BaseActionPropertyActionQuery extends ModelCriteria
{
    ...
    public function filterByActionProperty($actionProperty, $comparison = null)
    {
        if ($actionProperty instanceof ActionProperty) {
            return $this
                ->addUsingAlias(ActionPropertyActionPeer::ID, $actionProperty->getid(), $comparison);
            ...
            return $this
                ->addUsingAlias(ActionPropertyActionPeer::ID, $actionProperty->toKeyValue('PrimaryKey', 'id'), $comparison);
        } else {
