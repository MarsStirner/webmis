...
/**
 * Base class that represents a row from the 'rbMedicalAidUnit' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseRbmedicalaidunit extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbmedicalaidunitPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RbmedicalaidunitPeer
     */
     ...
     * @return Rbmedicalaidunit The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbmedicalaidunitPeer::ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = RbmedicalaidunitPeer::CODE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbmedicalaidunitPeer::NAME;
        }
    ...
    public function setDescr($v)
    {
        ...
        if ($this->descr !== $v) {
            $this->descr = $v;
            $this->modifiedColumns[] = RbmedicalaidunitPeer::DESCR;
        }
    ...
    public function setRegionalcode($v)
    {
        ...
        if ($this->regionalcode !== $v) {
            $this->regionalcode = $v;
            $this->modifiedColumns[] = RbmedicalaidunitPeer::REGIONALCODE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->regionalcode = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = RbmedicalaidunitPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Rbmedicalaidunit object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbmedicalaidunitPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbmedicalaidunitQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbmedicalaidunitPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbmedicalaidunitPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbmedicalaidunitPeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(RbmedicalaidunitPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(RbmedicalaidunitPeer::DESCR)) {
            $modifiedColumns[':p' . $index++]  = '`descr`';
        }
        if ($this->isColumnModified(RbmedicalaidunitPeer::REGIONALCODE)) {
            $modifiedColumns[':p' . $index++]  = '`regionalCode`';
        }

        $sql = sprintf(
            'INSERT INTO `rbMedicalAidUnit` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbmedicalaidunitPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbmedicalaidunitPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Rbmedicalaidunit'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Rbmedicalaidunit'][$this->getPrimaryKey()] = true;
        $keys = RbmedicalaidunitPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getDescr(),
            $keys[4] => $this->getRegionalcode(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setRegionalcode($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbmedicalaidunitPeer::ID)) $criteria->add(RbmedicalaidunitPeer::ID, $this->id);
        if ($this->isColumnModified(RbmedicalaidunitPeer::CODE)) $criteria->add(RbmedicalaidunitPeer::CODE, $this->code);
        if ($this->isColumnModified(RbmedicalaidunitPeer::NAME)) $criteria->add(RbmedicalaidunitPeer::NAME, $this->name);
        if ($this->isColumnModified(RbmedicalaidunitPeer::DESCR)) $criteria->add(RbmedicalaidunitPeer::DESCR, $this->descr);
        if ($this->isColumnModified(RbmedicalaidunitPeer::REGIONALCODE)) $criteria->add(RbmedicalaidunitPeer::REGIONALCODE, $this->regionalcode);
    ...
    {
        $criteria = new Criteria(RbmedicalaidunitPeer::DATABASE_NAME);
        $criteria->add(RbmedicalaidunitPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Rbmedicalaidunit (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Rbmedicalaidunit Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbmedicalaidunitPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbmedicalaidunitPeer();
        }
     ...
     * If this Rbmedicalaidunit is new, it will return
    ...
    public function setMedicalkindunits(PropelCollection $medicalkindunits, PropelPDO $con = null)
    {
        ...
        foreach ($medicalkindunitsToDelete as $medicalkindunitRemoved) {
            $medicalkindunitRemoved->setRbmedicalaidunit(null);
        }
    ...
    protected function doAddMedicalkindunit($medicalkindunit)
    {
        ...
        $medicalkindunit->setRbmedicalaidunit($this);
    }
    ...
    public function removeMedicalkindunit($medicalkindunit)
    {
        if ($this->getMedicalkindunits()->contains($medicalkindunit)) {
            ...
            $medicalkindunit->setRbmedicalaidunit(null);
        }
     ...
     * Otherwise if this Rbmedicalaidunit is new, it will return
     * an empty collection; or if this Rbmedicalaidunit has previously
     * been saved, it will retrieve related Medicalkindunits from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Rbmedicalaidunit.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(RbmedicalaidunitPeer::DEFAULT_STRING_FORMAT);
    }
