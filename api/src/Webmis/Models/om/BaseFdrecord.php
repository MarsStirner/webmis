...
abstract class BaseFdrecord extends BaseObject implements Persistent
{
    ...
    public function setFlatdirectoryRelatedByFlatdirectoryId(Flatdirectory $v = null)
    {
        ...
        if ($v !== null) {
            $v->addFdrecordRelatedByFlatdirectoryId($this);
        }
    ...
    public function getFlatdirectoryRelatedByFlatdirectoryId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFlatdirectoryRelatedByFlatdirectoryId === null && ($this->flatdirectory_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFlatdirectoryRelatedByFlatdirectoryId->addFdrecordsRelatedByFlatdirectoryId($this);
             */
        }
    ...
    public function setFlatdirectoryRelatedByFlatdirectoryCode(Flatdirectory $v = null)
    {
        ...
        // If this object has already been added to the Flatdirectory object, it will not be re-added.
        if ($v !== null) {
            $v->addFdrecordRelatedByFlatdirectoryCode($this);
        }
    ...
    public function getFlatdirectoryRelatedByFlatdirectoryCode(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFlatdirectoryRelatedByFlatdirectoryCode === null && (($this->flatdirectory_code !== "" && $this->flatdirectory_code !== null)) && $doQuery) {
            $this->aFlatdirectoryRelatedByFlatdirectoryCode = FlatdirectoryQuery::create()
                ->filterByFdrecordRelatedByFlatdirectoryCode($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFlatdirectoryRelatedByFlatdirectoryCode->addFdrecordsRelatedByFlatdirectoryCode($this);
             */
        }
    ...
    public function setClientflatdirectorys(PropelCollection $clientflatdirectorys, PropelPDO $con = null)
    {
        ...
        foreach ($clientflatdirectorysToDelete as $clientflatdirectoryRemoved) {
            $clientflatdirectoryRemoved->setFdrecord(null);
        }
    ...
    protected function doAddClientflatdirectory($clientflatdirectory)
    {
        ...
        $clientflatdirectory->setFdrecord($this);
    }
    ...
    public function removeClientflatdirectory($clientflatdirectory)
    {
        if ($this->getClientflatdirectorys()->contains($clientflatdirectory)) {
            ...
            $clientflatdirectory->setFdrecord(null);
        }
