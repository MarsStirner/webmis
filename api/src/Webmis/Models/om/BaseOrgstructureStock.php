...
/**
 * Base class that represents a row from the 'OrgStructure_Stock' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseOrgstructureStock extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\OrgstructureStockPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        OrgstructureStockPeer
     */
    ...
    /**
     * The value for the constrainedqnt field.
     * Note: this column has a database default value of: 0
     * @var        double
     */
    protected $constrainedqnt;

    /**
     * The value for the orderqnt field.
     * Note: this column has a database default value of: 0
     * @var        double
     */
    protected $orderqnt;
    ...
    {
        $this->idx = 0;
        $this->constrainedqnt = 0;
        $this->orderqnt = 0;
    }

    /**
     * Initializes internal state of BaseOrgstructureStock object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [constrainedqnt] column value.
     *
     * @return double
     */
    public function getConstrainedqnt()
    {
        return $this->constrainedqnt;
    }

    /**
     * Get the [orderqnt] column value.
     *
     * @return double
     */
    public function getOrderqnt()
    {
        return $this->orderqnt;
    }
     ...
     * @return OrgstructureStock The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = OrgstructureStockPeer::ID;
        }
    ...
    public function setMasterId($v)
    {
        ...
        if ($this->master_id !== $v) {
            $this->master_id = $v;
            $this->modifiedColumns[] = OrgstructureStockPeer::MASTER_ID;
        }
    ...
    public function setIdx($v)
    {
        ...
        if ($this->idx !== $v) {
            $this->idx = $v;
            $this->modifiedColumns[] = OrgstructureStockPeer::IDX;
        }
    ...
    public function setNomenclatureId($v)
    {
        ...
        if ($this->nomenclature_id !== $v) {
            ...
            $this->modifiedColumns[] = OrgstructureStockPeer::NOMENCLATURE_ID;
        }
    ...
    public function setFinanceId($v)
    {
        ...
        if ($this->finance_id !== $v) {
            $this->finance_id = $v;
            $this->modifiedColumns[] = OrgstructureStockPeer::FINANCE_ID;
        }
    ...
    /**
     * Set the value of [constrainedqnt] column.
     *
     * @param double $v new value
     * @return OrgstructureStock The current object (for fluent API support)
     */
    public function setConstrainedqnt($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (double) $v;
        }

        if ($this->constrainedqnt !== $v) {
            $this->constrainedqnt = $v;
            $this->modifiedColumns[] = OrgstructureStockPeer::CONSTRAINEDQNT;
        }
    ...
    /**
     * Set the value of [orderqnt] column.
     *
     * @param double $v new value
     * @return OrgstructureStock The current object (for fluent API support)
     */
    public function setOrderqnt($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (double) $v;
        }
        ...
        if ($this->orderqnt !== $v) {
            $this->orderqnt = $v;
            $this->modifiedColumns[] = OrgstructureStockPeer::ORDERQNT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->constrainedqnt = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
            $this->orderqnt = ($row[$startcol + 6] !== null) ? (double) $row[$startcol + 6] : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = OrgstructureStockPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating OrgstructureStock object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OrgstructureStockPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OrgstructureStockQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OrgstructureStockPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OrgstructureStockPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(OrgstructureStockPeer::MASTER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`master_id`';
        }
        if ($this->isColumnModified(OrgstructureStockPeer::IDX)) {
            $modifiedColumns[':p' . $index++]  = '`idx`';
        }
        if ($this->isColumnModified(OrgstructureStockPeer::NOMENCLATURE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`nomenclature_id`';
        }
        if ($this->isColumnModified(OrgstructureStockPeer::FINANCE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`finance_id`';
        }
        if ($this->isColumnModified(OrgstructureStockPeer::CONSTRAINEDQNT)) {
            $modifiedColumns[':p' . $index++]  = '`constrainedQnt`';
        }
        if ($this->isColumnModified(OrgstructureStockPeer::ORDERQNT)) {
            $modifiedColumns[':p' . $index++]  = '`orderQnt`';
        }

        $sql = sprintf(
            'INSERT INTO `OrgStructure_Stock` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`finance_id`':
                        ...
                        break;
                    case '`constrainedQnt`':
                        $stmt->bindValue($identifier, $this->constrainedqnt, PDO::PARAM_STR);
                        break;
                    case '`orderQnt`':
                        $stmt->bindValue($identifier, $this->orderqnt, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OrgstructureStockPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OrgstructureStockPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                return $this->getConstrainedqnt();
                break;
            case 6:
                return $this->getOrderqnt();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['OrgstructureStock'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OrgstructureStock'][$this->getPrimaryKey()] = true;
        $keys = OrgstructureStockPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[5] => $this->getConstrainedqnt(),
            $keys[6] => $this->getOrderqnt(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 4:
                ...
                break;
            case 5:
                $this->setConstrainedqnt($value);
                break;
            case 6:
                $this->setOrderqnt($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setConstrainedqnt($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setOrderqnt($arr[$keys[6]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OrgstructureStockPeer::ID)) $criteria->add(OrgstructureStockPeer::ID, $this->id);
        if ($this->isColumnModified(OrgstructureStockPeer::MASTER_ID)) $criteria->add(OrgstructureStockPeer::MASTER_ID, $this->master_id);
        if ($this->isColumnModified(OrgstructureStockPeer::IDX)) $criteria->add(OrgstructureStockPeer::IDX, $this->idx);
        if ($this->isColumnModified(OrgstructureStockPeer::NOMENCLATURE_ID)) $criteria->add(OrgstructureStockPeer::NOMENCLATURE_ID, $this->nomenclature_id);
        if ($this->isColumnModified(OrgstructureStockPeer::FINANCE_ID)) $criteria->add(OrgstructureStockPeer::FINANCE_ID, $this->finance_id);
        if ($this->isColumnModified(OrgstructureStockPeer::CONSTRAINEDQNT)) $criteria->add(OrgstructureStockPeer::CONSTRAINEDQNT, $this->constrainedqnt);
        if ($this->isColumnModified(OrgstructureStockPeer::ORDERQNT)) $criteria->add(OrgstructureStockPeer::ORDERQNT, $this->orderqnt);
    ...
    {
        $criteria = new Criteria(OrgstructureStockPeer::DATABASE_NAME);
        $criteria->add(OrgstructureStockPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of OrgstructureStock (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setConstrainedqnt($this->getConstrainedqnt());
        $copyObj->setOrderqnt($this->getOrderqnt());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OrgstructureStock Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return OrgstructureStockPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new OrgstructureStockPeer();
        }
    ...
    public function getRbfinance(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRbfinance === null && ($this->finance_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aRbfinance->addOrgstructureStocks($this);
             */
        }
    ...
    public function getOrgstructure(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrgstructure === null && ($this->master_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOrgstructure->addOrgstructureStocks($this);
             */
        }
    ...
    public function getRbnomenclature(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRbnomenclature === null && ($this->nomenclature_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRbnomenclature->addOrgstructureStocks($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(OrgstructureStockPeer::DEFAULT_STRING_FORMAT);
    }
