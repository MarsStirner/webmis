...
/**
 * Base class that represents a row from the 'ActionProperty_Double' table.
 *
 *
 *
 * @package    propel.generator.Models.om
 */
abstract class BaseActionPropertyDouble extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ActionPropertyDoublePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ActionPropertyDoublePeer
     */
    ...
    /**
     * Initializes internal state of BaseActionPropertyDouble object.
     * @see        applyDefaults()
     */
     ...
     * @return ActionPropertyDouble The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ActionPropertyDoublePeer::ID;
        }
    ...
    public function setindex($v)
    {
        ...
        if ($this->index !== $v) {
            $this->index = $v;
            $this->modifiedColumns[] = ActionPropertyDoublePeer::INDEX;
        }
    ...
    public function setvalue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = ActionPropertyDoublePeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ActionPropertyDoublePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ActionPropertyDouble object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ActionPropertyDoublePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ActionPropertyDoubleQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ActionPropertyDoublePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ActionPropertyDoublePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ActionPropertyDoublePeer::INDEX)) {
            $modifiedColumns[':p' . $index++]  = '`index`';
        }
        if ($this->isColumnModified(ActionPropertyDoublePeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }

        $sql = sprintf(
            'INSERT INTO `ActionProperty_Double` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ActionPropertyDoublePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ActionPropertyDoublePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ActionPropertyDouble'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ActionPropertyDouble'][serialize($this->getPrimaryKey())] = true;
        $keys = ActionPropertyDoublePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ActionPropertyDoublePeer::ID)) $criteria->add(ActionPropertyDoublePeer::ID, $this->id);
        if ($this->isColumnModified(ActionPropertyDoublePeer::INDEX)) $criteria->add(ActionPropertyDoublePeer::INDEX, $this->index);
        if ($this->isColumnModified(ActionPropertyDoublePeer::VALUE)) $criteria->add(ActionPropertyDoublePeer::VALUE, $this->value);
    ...
    {
        $criteria = new Criteria(ActionPropertyDoublePeer::DATABASE_NAME);
        $criteria->add(ActionPropertyDoublePeer::ID, $this->id);
        $criteria->add(ActionPropertyDoublePeer::INDEX, $this->index);
     ...
     * objects.
     *
     * @param object $copyObj An object of ActionPropertyDouble (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ActionPropertyDouble Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ActionPropertyDoublePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ActionPropertyDoublePeer();
        }
    ...
    public function setActionProperty(ActionProperty $v = null)
    {
        ...
        if ($v !== null && $v->getActionPropertyDouble(null, false) === null) {
            $v->setActionPropertyDouble($this);
        }
    ...
    {
        return (string) $this->exportTo(ActionPropertyDoublePeer::DEFAULT_STRING_FORMAT);
    }
