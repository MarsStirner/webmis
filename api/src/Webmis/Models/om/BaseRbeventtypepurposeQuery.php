 ...
 *
 * @method RbeventtypepurposeQuery leftJoinRbacheresult($relationAlias = null) Adds a LEFT JOIN clause to the query using the Rbacheresult relation
 * @method RbeventtypepurposeQuery rightJoinRbacheresult($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Rbacheresult relation
 * @method RbeventtypepurposeQuery innerJoinRbacheresult($relationAlias = null) Adds a INNER JOIN clause to the query using the Rbacheresult relation
 *
...
abstract class BaseRbeventtypepurposeQuery extends ModelCriteria
{
     ...
     *
     * @param   Rbacheresult|PropelObjectCollection $rbacheresult  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 RbeventtypepurposeQuery The current query, for fluid interface
    ...
    public function filterByRbacheresult($rbacheresult, $comparison = null)
    {
        if ($rbacheresult instanceof Rbacheresult) {
            return $this
                ->addUsingAlias(RbeventtypepurposePeer::ID, $rbacheresult->getEventpurposeId(), $comparison);
        } elseif ($rbacheresult instanceof PropelObjectCollection) {
            return $this
                ->useRbacheresultQuery()
                ->filterByPrimaryKeys($rbacheresult->getPrimaryKeys())
                ->endUse();
        } else {
     ...
     * @return RbeventtypepurposeQuery The current query, for fluid interface
     */
    public function joinRbacheresult($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     */
    public function useRbacheresultQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
