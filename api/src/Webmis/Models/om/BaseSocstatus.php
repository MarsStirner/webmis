...
/**
 * Base class that represents a row from the 'SocStatus' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseSocstatus extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\SocstatusPeer';
    ...
    /**
     * Initializes internal state of BaseSocstatus object.
     * @see        applyDefaults()
     */
     ...
     * @return Socstatus The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = SocstatusPeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SocstatusPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = SocstatusPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SocstatusPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = SocstatusPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = SocstatusPeer::DELETED;
        }
    ...
    public function setSocstatusclassId($v)
    {
        ...
        if ($this->socstatusclass_id !== $v) {
            ...
            $this->modifiedColumns[] = SocstatusPeer::SOCSTATUSCLASS_ID;
        }
    ...
    public function setSocstatustypeId($v)
    {
        ...
        if ($this->socstatustype_id !== $v) {
            ...
            $this->modifiedColumns[] = SocstatusPeer::SOCSTATUSTYPE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->socstatusclass_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->socstatustype_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = SocstatusPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Socstatus object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SocstatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SocstatusQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SocstatusPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SocstatusPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(SocstatusPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(SocstatusPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(SocstatusPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(SocstatusPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(SocstatusPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(SocstatusPeer::SOCSTATUSCLASS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`socStatusClass_id`';
        }
        if ($this->isColumnModified(SocstatusPeer::SOCSTATUSTYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`socStatusType_id`';
        }

        $sql = sprintf(
            'INSERT INTO `SocStatus` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SocstatusPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SocstatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Socstatus'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Socstatus'][$this->getPrimaryKey()] = true;
        $keys = SocstatusPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[6] => $this->getSocstatusclassId(),
            $keys[7] => $this->getSocstatustypeId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setSocstatusclassId($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setSocstatustypeId($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SocstatusPeer::ID)) $criteria->add(SocstatusPeer::ID, $this->id);
        if ($this->isColumnModified(SocstatusPeer::CREATEDATETIME)) $criteria->add(SocstatusPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(SocstatusPeer::CREATEPERSON_ID)) $criteria->add(SocstatusPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(SocstatusPeer::MODIFYDATETIME)) $criteria->add(SocstatusPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(SocstatusPeer::MODIFYPERSON_ID)) $criteria->add(SocstatusPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(SocstatusPeer::DELETED)) $criteria->add(SocstatusPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(SocstatusPeer::SOCSTATUSCLASS_ID)) $criteria->add(SocstatusPeer::SOCSTATUSCLASS_ID, $this->socstatusclass_id);
        if ($this->isColumnModified(SocstatusPeer::SOCSTATUSTYPE_ID)) $criteria->add(SocstatusPeer::SOCSTATUSTYPE_ID, $this->socstatustype_id);
    ...
    {
        $criteria = new Criteria(SocstatusPeer::DATABASE_NAME);
        $criteria->add(SocstatusPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Socstatus (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Socstatus Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return SocstatusPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new SocstatusPeer();
        }
    ...
    {
        return (string) $this->exportTo(SocstatusPeer::DEFAULT_STRING_FORMAT);
    }
