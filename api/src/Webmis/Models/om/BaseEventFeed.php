...
/**
 * Base class that represents a row from the 'Event_Feed' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseEventFeed extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\EventFeedPeer';
    ...
    /**
     * The value for the mealtime_id field.
     * @var        int
     */
    protected $mealtime_id;

    /**
     * The value for the diet_id field.
     * @var        int
     */
    protected $diet_id;
    ...
    /**
     * Initializes internal state of BaseEventFeed object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [mealtime_id] column value.
     *
     * @return int
     */
    public function getMealtimeId()
    {
        return $this->mealtime_id;
    }

    /**
     * Get the [diet_id] column value.
     *
     * @return int
     */
     ...
     * @return EventFeed The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = EventFeedPeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EventFeedPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = EventFeedPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EventFeedPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = EventFeedPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = EventFeedPeer::DELETED;
        }
    ...
    public function setEventId($v)
    {
        ...
        if ($this->event_id !== $v) {
            $this->event_id = $v;
            $this->modifiedColumns[] = EventFeedPeer::EVENT_ID;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EventFeedPeer::DATE;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [mealtime_id] column.
     *
     * @param int $v new value
     * @return EventFeed The current object (for fluent API support)
     */
    public function setMealtimeId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->mealtime_id !== $v) {
            $this->mealtime_id = $v;
            $this->modifiedColumns[] = EventFeedPeer::MEALTIME_ID;
        }
    ...
    /**
     * Set the value of [diet_id] column.
     *
     * @param int $v new value
     * @return EventFeed The current object (for fluent API support)
     */
    public function setDietId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }
        ...
        if ($this->diet_id !== $v) {
            $this->diet_id = $v;
            $this->modifiedColumns[] = EventFeedPeer::DIET_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->mealtime_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            $this->diet_id = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
            $this->resetModified();
            ...
            return $startcol + 10; // 10 = EventFeedPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating EventFeed object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EventFeedPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EventFeedQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventFeedPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EventFeedPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(EventFeedPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(EventFeedPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(EventFeedPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(EventFeedPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(EventFeedPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(EventFeedPeer::EVENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`event_id`';
        }
        if ($this->isColumnModified(EventFeedPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(EventFeedPeer::MEALTIME_ID)) {
            $modifiedColumns[':p' . $index++]  = '`mealTime_id`';
        }
        if ($this->isColumnModified(EventFeedPeer::DIET_ID)) {
            $modifiedColumns[':p' . $index++]  = '`diet_id`';
        }

        $sql = sprintf(
            'INSERT INTO `Event_Feed` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`date`':
                        ...
                        break;
                    case '`mealTime_id`':
                        $stmt->bindValue($identifier, $this->mealtime_id, PDO::PARAM_INT);
                        break;
                    case '`diet_id`':
                        $stmt->bindValue($identifier, $this->diet_id, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EventFeedPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EventFeedPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 7:
                ...
                break;
            case 8:
                return $this->getMealtimeId();
                break;
            case 9:
                return $this->getDietId();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['EventFeed'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EventFeed'][$this->getPrimaryKey()] = true;
        $keys = EventFeedPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[7] => $this->getDate(),
            $keys[8] => $this->getMealtimeId(),
            $keys[9] => $this->getDietId(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 7:
                ...
                break;
            case 8:
                $this->setMealtimeId($value);
                break;
            case 9:
                $this->setDietId($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[8], $arr)) $this->setMealtimeId($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setDietId($arr[$keys[9]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventFeedPeer::ID)) $criteria->add(EventFeedPeer::ID, $this->id);
        if ($this->isColumnModified(EventFeedPeer::CREATEDATETIME)) $criteria->add(EventFeedPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(EventFeedPeer::CREATEPERSON_ID)) $criteria->add(EventFeedPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(EventFeedPeer::MODIFYDATETIME)) $criteria->add(EventFeedPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(EventFeedPeer::MODIFYPERSON_ID)) $criteria->add(EventFeedPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(EventFeedPeer::DELETED)) $criteria->add(EventFeedPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(EventFeedPeer::EVENT_ID)) $criteria->add(EventFeedPeer::EVENT_ID, $this->event_id);
        if ($this->isColumnModified(EventFeedPeer::DATE)) $criteria->add(EventFeedPeer::DATE, $this->date);
        if ($this->isColumnModified(EventFeedPeer::MEALTIME_ID)) $criteria->add(EventFeedPeer::MEALTIME_ID, $this->mealtime_id);
        if ($this->isColumnModified(EventFeedPeer::DIET_ID)) $criteria->add(EventFeedPeer::DIET_ID, $this->diet_id);
    ...
    {
        $criteria = new Criteria(EventFeedPeer::DATABASE_NAME);
        $criteria->add(EventFeedPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of EventFeed (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMealtimeId($this->getMealtimeId());
        $copyObj->setDietId($this->getDietId());
        if ($makeNew) {
            $copyObj->setNew(true);
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EventFeed Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EventFeedPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EventFeedPeer();
        }
    ...
    {
        return (string) $this->exportTo(EventFeedPeer::DEFAULT_STRING_FORMAT);
    }
