...
abstract class BaseRlspacking extends BaseObject implements Persistent
{
    ...
    /**
     * Initializes internal state of BaseRlspacking object.
     * @see        applyDefaults()
     */
    ...
    public function setDisabledforprescription($v)
    {
        ...
        if ($this->disabledforprescription !== $v) {
            ...
            $this->modifiedColumns[] = RlspackingPeer::DISABLEDFORPRESCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = RlspackingPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RlspackingPeer::DISABLEDFORPRESCRIPTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RlspackingPeer::DISABLEDFORPRESCRIPTION)) $criteria->add(RlspackingPeer::DISABLEDFORPRESCRIPTION, $this->disabledforprescription);
