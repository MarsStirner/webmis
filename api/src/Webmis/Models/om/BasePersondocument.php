...
/**
 * Base class that represents a row from the 'PersonDocument' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BasePersondocument extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\PersondocumentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PersondocumentPeer
     */
     ...
     * @return Persondocument The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PersondocumentPeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PersondocumentPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = PersondocumentPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PersondocumentPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = PersondocumentPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = PersondocumentPeer::DELETED;
        }
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = PersondocumentPeer::PERSON_ID;
        }
    ...
    public function setDocumenttypeId($v)
    {
        ...
        if ($this->documenttype_id !== $v) {
            ...
            $this->modifiedColumns[] = PersondocumentPeer::DOCUMENTTYPE_ID;
        }
    ...
    public function setSerial($v)
    {
        ...
        if ($this->serial !== $v) {
            $this->serial = $v;
            $this->modifiedColumns[] = PersondocumentPeer::SERIAL;
        }
    ...
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[] = PersondocumentPeer::NUMBER;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PersondocumentPeer::DATE;
            }
        } // if either are not null
    ...
    public function setOrigin($v)
    {
        ...
        if ($this->origin !== $v) {
            $this->origin = $v;
            $this->modifiedColumns[] = PersondocumentPeer::ORIGIN;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 12; // 12 = PersondocumentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Persondocument object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PersondocumentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PersondocumentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PersondocumentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PersondocumentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PersondocumentPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(PersondocumentPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(PersondocumentPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(PersondocumentPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(PersondocumentPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(PersondocumentPeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`person_id`';
        }
        if ($this->isColumnModified(PersondocumentPeer::DOCUMENTTYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`documentType_id`';
        }
        if ($this->isColumnModified(PersondocumentPeer::SERIAL)) {
            $modifiedColumns[':p' . $index++]  = '`serial`';
        }
        if ($this->isColumnModified(PersondocumentPeer::NUMBER)) {
            $modifiedColumns[':p' . $index++]  = '`number`';
        }
        if ($this->isColumnModified(PersondocumentPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(PersondocumentPeer::ORIGIN)) {
            $modifiedColumns[':p' . $index++]  = '`origin`';
        }

        $sql = sprintf(
            'INSERT INTO `PersonDocument` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PersondocumentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PersondocumentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Persondocument'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Persondocument'][$this->getPrimaryKey()] = true;
        $keys = PersondocumentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PersondocumentPeer::ID)) $criteria->add(PersondocumentPeer::ID, $this->id);
        if ($this->isColumnModified(PersondocumentPeer::CREATEDATETIME)) $criteria->add(PersondocumentPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(PersondocumentPeer::CREATEPERSON_ID)) $criteria->add(PersondocumentPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(PersondocumentPeer::MODIFYDATETIME)) $criteria->add(PersondocumentPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(PersondocumentPeer::MODIFYPERSON_ID)) $criteria->add(PersondocumentPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(PersondocumentPeer::DELETED)) $criteria->add(PersondocumentPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(PersondocumentPeer::PERSON_ID)) $criteria->add(PersondocumentPeer::PERSON_ID, $this->person_id);
        if ($this->isColumnModified(PersondocumentPeer::DOCUMENTTYPE_ID)) $criteria->add(PersondocumentPeer::DOCUMENTTYPE_ID, $this->documenttype_id);
        if ($this->isColumnModified(PersondocumentPeer::SERIAL)) $criteria->add(PersondocumentPeer::SERIAL, $this->serial);
        if ($this->isColumnModified(PersondocumentPeer::NUMBER)) $criteria->add(PersondocumentPeer::NUMBER, $this->number);
        if ($this->isColumnModified(PersondocumentPeer::DATE)) $criteria->add(PersondocumentPeer::DATE, $this->date);
        if ($this->isColumnModified(PersondocumentPeer::ORIGIN)) $criteria->add(PersondocumentPeer::ORIGIN, $this->origin);
    ...
    {
        $criteria = new Criteria(PersondocumentPeer::DATABASE_NAME);
        $criteria->add(PersondocumentPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Persondocument (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Persondocument Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PersondocumentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PersondocumentPeer();
        }
    ...
    {
        return (string) $this->exportTo(PersondocumentPeer::DEFAULT_STRING_FORMAT);
    }
