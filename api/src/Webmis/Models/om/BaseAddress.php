...
abstract class BaseAddress extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\AddressPeer';
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AddressPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = AddressPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AddressPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = AddressPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = AddressPeer::DELETED;
        }
    ...
    public function setHouseId($v)
    {
        ...
        if ($this->house_id !== $v) {
            $this->house_id = $v;
            $this->modifiedColumns[] = AddressPeer::HOUSE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->house_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->flat = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = AddressPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AddressPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(AddressPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(AddressPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(AddressPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(AddressPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(AddressPeer::HOUSE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`house_id`';
        }
        if ($this->isColumnModified(AddressPeer::FLAT)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setHouseId($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setFlat($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AddressPeer::CREATEDATETIME)) $criteria->add(AddressPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(AddressPeer::CREATEPERSON_ID)) $criteria->add(AddressPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(AddressPeer::MODIFYDATETIME)) $criteria->add(AddressPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(AddressPeer::MODIFYPERSON_ID)) $criteria->add(AddressPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(AddressPeer::DELETED)) $criteria->add(AddressPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(AddressPeer::HOUSE_ID)) $criteria->add(AddressPeer::HOUSE_ID, $this->house_id);
