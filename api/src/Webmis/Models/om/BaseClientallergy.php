...
/**
 * Base class that represents a row from the 'ClientAllergy' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseClientallergy extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ClientallergyPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ClientallergyPeer
     */
    ...
    /**
     * The value for the namesubstance field.
     * @var        string
     */
    protected $namesubstance;
    ...
    /**
     * Initializes internal state of BaseClientallergy object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [namesubstance] column value.
     *
     * @return string
     */
    public function getNamesubstance()
    {
        return $this->namesubstance;
    }
     ...
     * @return Clientallergy The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ClientallergyPeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientallergyPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientallergyPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientallergyPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientallergyPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = ClientallergyPeer::DELETED;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = ClientallergyPeer::CLIENT_ID;
        }
    ...
    /**
     * Set the value of [namesubstance] column.
     *
     * @param string $v new value
     * @return Clientallergy The current object (for fluent API support)
     */
    public function setNamesubstance($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->namesubstance !== $v) {
            $this->namesubstance = $v;
            $this->modifiedColumns[] = ClientallergyPeer::NAMESUBSTANCE;
        }
    ...
    public function setPower($v)
    {
        ...
        if ($this->power !== $v) {
            $this->power = $v;
            $this->modifiedColumns[] = ClientallergyPeer::POWER;
        }
    ...
    public function setCreatedate($v)
    {
        ...
        if ($this->createdate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientallergyPeer::CREATEDATE;
            }
        } // if either are not null
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[] = ClientallergyPeer::NOTES;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = ClientallergyPeer::VERSION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->namesubstance = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            ...
            return $startcol + 12; // 12 = ClientallergyPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Clientallergy object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ClientallergyPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ClientallergyQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ClientallergyPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClientallergyPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ClientallergyPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(ClientallergyPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(ClientallergyPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(ClientallergyPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(ClientallergyPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(ClientallergyPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(ClientallergyPeer::NAMESUBSTANCE)) {
            $modifiedColumns[':p' . $index++]  = '`nameSubstance`';
        }
        if ($this->isColumnModified(ClientallergyPeer::POWER)) {
            $modifiedColumns[':p' . $index++]  = '`power`';
        }
        if ($this->isColumnModified(ClientallergyPeer::CREATEDATE)) {
            $modifiedColumns[':p' . $index++]  = '`createDate`';
        }
        if ($this->isColumnModified(ClientallergyPeer::NOTES)) {
            $modifiedColumns[':p' . $index++]  = '`notes`';
        }
        if ($this->isColumnModified(ClientallergyPeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`version`';
        }

        $sql = sprintf(
            'INSERT INTO `ClientAllergy` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`client_id`':
                        ...
                        break;
                    case '`nameSubstance`':
                        $stmt->bindValue($identifier, $this->namesubstance, PDO::PARAM_STR);
                        break;
                    case '`power`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ClientallergyPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ClientallergyPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Clientallergy'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Clientallergy'][$this->getPrimaryKey()] = true;
        $keys = ClientallergyPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setNamesubstance($arr[$keys[7]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientallergyPeer::ID)) $criteria->add(ClientallergyPeer::ID, $this->id);
        if ($this->isColumnModified(ClientallergyPeer::CREATEDATETIME)) $criteria->add(ClientallergyPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(ClientallergyPeer::CREATEPERSON_ID)) $criteria->add(ClientallergyPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(ClientallergyPeer::MODIFYDATETIME)) $criteria->add(ClientallergyPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(ClientallergyPeer::MODIFYPERSON_ID)) $criteria->add(ClientallergyPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(ClientallergyPeer::DELETED)) $criteria->add(ClientallergyPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(ClientallergyPeer::CLIENT_ID)) $criteria->add(ClientallergyPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(ClientallergyPeer::NAMESUBSTANCE)) $criteria->add(ClientallergyPeer::NAMESUBSTANCE, $this->namesubstance);
        if ($this->isColumnModified(ClientallergyPeer::POWER)) $criteria->add(ClientallergyPeer::POWER, $this->power);
        if ($this->isColumnModified(ClientallergyPeer::CREATEDATE)) $criteria->add(ClientallergyPeer::CREATEDATE, $this->createdate);
        if ($this->isColumnModified(ClientallergyPeer::NOTES)) $criteria->add(ClientallergyPeer::NOTES, $this->notes);
        if ($this->isColumnModified(ClientallergyPeer::VERSION)) $criteria->add(ClientallergyPeer::VERSION, $this->version);
    ...
    {
        $criteria = new Criteria(ClientallergyPeer::DATABASE_NAME);
        $criteria->add(ClientallergyPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Clientallergy (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNamesubstance($this->getNamesubstance());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Clientallergy Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ClientallergyPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ClientallergyPeer();
        }
    ...
    {
        return (string) $this->exportTo(ClientallergyPeer::DEFAULT_STRING_FORMAT);
    }
