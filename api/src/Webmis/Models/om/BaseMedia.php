...
abstract class BaseMedia extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\MediaPeer';
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            if ($row[$startcol + 2] !== null) {
                $this->file = fopen('php://memory', 'r+');
                fwrite($this->file, $row[$startcol + 2]);
                rewind($this->file);
            } else {
                $this->file = null;
            }
            ...
            return $startcol + 3; // 3 = MediaPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MediaPeer::FILENAME)) {
