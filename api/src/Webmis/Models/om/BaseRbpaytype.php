...
/**
 * Base class that represents a row from the 'rbPayType' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseRbpaytype extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbpaytypePeer';
     ...
     * @return Rbpaytype The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbpaytypePeer::ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = RbpaytypePeer::CODE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbpaytypePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = RbpaytypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Rbpaytype object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbpaytypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbpaytypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbpaytypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbpaytypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbpaytypePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(RbpaytypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `rbPayType` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbpaytypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbpaytypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Rbpaytype'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Rbpaytype'][$this->getPrimaryKey()] = true;
        $keys = RbpaytypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
            $keys[2] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbpaytypePeer::ID)) $criteria->add(RbpaytypePeer::ID, $this->id);
        if ($this->isColumnModified(RbpaytypePeer::CODE)) $criteria->add(RbpaytypePeer::CODE, $this->code);
        if ($this->isColumnModified(RbpaytypePeer::NAME)) $criteria->add(RbpaytypePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(RbpaytypePeer::DATABASE_NAME);
        $criteria->add(RbpaytypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Rbpaytype (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Rbpaytype Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbpaytypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbpaytypePeer();
        }
     ...
     * If this Rbpaytype is new, it will return
    ...
    public function setMedicalkindunits(PropelCollection $medicalkindunits, PropelPDO $con = null)
    {
        ...
        foreach ($medicalkindunitsToDelete as $medicalkindunitRemoved) {
            $medicalkindunitRemoved->setRbpaytype(null);
        }
    ...
    protected function doAddMedicalkindunit($medicalkindunit)
    {
        ...
        $medicalkindunit->setRbpaytype($this);
    }
    ...
    public function removeMedicalkindunit($medicalkindunit)
    {
        if ($this->getMedicalkindunits()->contains($medicalkindunit)) {
            ...
            $medicalkindunit->setRbpaytype(null);
        }
     ...
     * Otherwise if this Rbpaytype is new, it will return
     * an empty collection; or if this Rbpaytype has previously
     * been saved, it will retrieve related Medicalkindunits from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Rbpaytype.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(RbpaytypePeer::DEFAULT_STRING_FORMAT);
    }
