...
/**
 * Base class that represents a row from the 'Diagnosis' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseDiagnosis extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\DiagnosisPeer';
    ...
    /**
     * Initializes internal state of BaseDiagnosis object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [mkbex] column value.
     *
     * @return string
     */
    public function getMkbex()
    {
        return $this->mkbex;
    }
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getSetdate($format = '%x')
    {
        if ($this->setdate === null) {
            return null;
        }

        if ($this->setdate === '0000-00-00') {
            // while technically this is not a default value of null,
            // this seems to be closest in meaning.
            return null;
        }
     ...
     * @return Diagnosis The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DiagnosisPeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DiagnosisPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = DiagnosisPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DiagnosisPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = DiagnosisPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = DiagnosisPeer::DELETED;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = DiagnosisPeer::CLIENT_ID;
        }
    ...
    public function setDiagnosistypeId($v)
    {
        ...
        if ($this->diagnosistype_id !== $v) {
            ...
            $this->modifiedColumns[] = DiagnosisPeer::DIAGNOSISTYPE_ID;
        }
    ...
    public function setCharacterId($v)
    {
        ...
        if ($this->character_id !== $v) {
            $this->character_id = $v;
            $this->modifiedColumns[] = DiagnosisPeer::CHARACTER_ID;
        }
    ...
    public function setMkb($v)
    {
        ...
        if ($this->mkb !== $v) {
            $this->mkb = $v;
            $this->modifiedColumns[] = DiagnosisPeer::MKB;
        }
    ...
    /**
     * Set the value of [mkbex] column.
     *
     * @param string $v new value
     * @return Diagnosis The current object (for fluent API support)
     */
    public function setMkbex($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->mkbex !== $v) {
            $this->mkbex = $v;
            $this->modifiedColumns[] = DiagnosisPeer::MKBEX;
        }
    ...
    public function setDispanserId($v)
    {
        ...
        if ($this->dispanser_id !== $v) {
            $this->dispanser_id = $v;
            $this->modifiedColumns[] = DiagnosisPeer::DISPANSER_ID;
        }
    ...
    public function setTraumatypeId($v)
    {
        ...
        if ($this->traumatype_id !== $v) {
            ...
            $this->modifiedColumns[] = DiagnosisPeer::TRAUMATYPE_ID;
        }
    ...
    public function setSetdate($v)
    {
        ...
        if ($this->setdate !== null || $dt !== null) {
            $currentDateAsString = ($this->setdate !== null && $tmpDt = new DateTime($this->setdate)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->setdate = $newDateAsString;
                $this->modifiedColumns[] = DiagnosisPeer::SETDATE;
            }
        } // if either are not null
    ...
    public function setEnddate($v)
    {
        ...
        if ($this->enddate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DiagnosisPeer::ENDDATE;
            }
        } // if either are not null
    ...
    public function setModId($v)
    {
        ...
        if ($this->mod_id !== $v) {
            $this->mod_id = $v;
            $this->modifiedColumns[] = DiagnosisPeer::MOD_ID;
        }
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = DiagnosisPeer::PERSON_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->diagnosistype_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->character_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            $this->mkb = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->mkbex = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->dispanser_id = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
            $this->traumatype_id = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
            $this->setdate = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->enddate = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->mod_id = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
            $this->person_id = ($row[$startcol + 16] !== null) ? (int) $row[$startcol + 16] : null;
            $this->resetModified();
            ...
            return $startcol + 17; // 17 = DiagnosisPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Diagnosis object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DiagnosisPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DiagnosisQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DiagnosisPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DiagnosisPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DiagnosisPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(DiagnosisPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(DiagnosisPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(DiagnosisPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(DiagnosisPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(DiagnosisPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(DiagnosisPeer::DIAGNOSISTYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`diagnosisType_id`';
        }
        if ($this->isColumnModified(DiagnosisPeer::CHARACTER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`character_id`';
        }
        if ($this->isColumnModified(DiagnosisPeer::MKB)) {
            $modifiedColumns[':p' . $index++]  = '`MKB`';
        }
        if ($this->isColumnModified(DiagnosisPeer::MKBEX)) {
            $modifiedColumns[':p' . $index++]  = '`MKBEx`';
        }
        if ($this->isColumnModified(DiagnosisPeer::DISPANSER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`dispanser_id`';
        }
        if ($this->isColumnModified(DiagnosisPeer::TRAUMATYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`traumaType_id`';
        }
        if ($this->isColumnModified(DiagnosisPeer::SETDATE)) {
            $modifiedColumns[':p' . $index++]  = '`setDate`';
        }
        if ($this->isColumnModified(DiagnosisPeer::ENDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`endDate`';
        }
        if ($this->isColumnModified(DiagnosisPeer::MOD_ID)) {
            $modifiedColumns[':p' . $index++]  = '`mod_id`';
        }
        if ($this->isColumnModified(DiagnosisPeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`person_id`';
        }

        $sql = sprintf(
            'INSERT INTO `Diagnosis` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`MKB`':
                        ...
                        break;
                    case '`MKBEx`':
                        $stmt->bindValue($identifier, $this->mkbex, PDO::PARAM_STR);
                        break;
                    case '`dispanser_id`':
                    ...
                    case '`endDate`':
                        ...
                        break;
                    case '`mod_id`':
                        $stmt->bindValue($identifier, $this->mod_id, PDO::PARAM_INT);
                        break;
                    case '`person_id`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DiagnosisPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DiagnosisPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Diagnosis'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Diagnosis'][$this->getPrimaryKey()] = true;
        $keys = DiagnosisPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[7] => $this->getDiagnosistypeId(),
            $keys[8] => $this->getCharacterId(),
            $keys[9] => $this->getMkb(),
            $keys[10] => $this->getMkbex(),
            $keys[11] => $this->getDispanserId(),
            $keys[12] => $this->getTraumatypeId(),
            $keys[13] => $this->getSetdate(),
            $keys[14] => $this->getEnddate(),
            $keys[15] => $this->getModId(),
            $keys[16] => $this->getPersonId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setDiagnosistypeId($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setCharacterId($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setMkb($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setMkbex($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setDispanserId($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setTraumatypeId($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setSetdate($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setEnddate($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setModId($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setPersonId($arr[$keys[16]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DiagnosisPeer::ID)) $criteria->add(DiagnosisPeer::ID, $this->id);
        if ($this->isColumnModified(DiagnosisPeer::CREATEDATETIME)) $criteria->add(DiagnosisPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(DiagnosisPeer::CREATEPERSON_ID)) $criteria->add(DiagnosisPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(DiagnosisPeer::MODIFYDATETIME)) $criteria->add(DiagnosisPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(DiagnosisPeer::MODIFYPERSON_ID)) $criteria->add(DiagnosisPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(DiagnosisPeer::DELETED)) $criteria->add(DiagnosisPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(DiagnosisPeer::CLIENT_ID)) $criteria->add(DiagnosisPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(DiagnosisPeer::DIAGNOSISTYPE_ID)) $criteria->add(DiagnosisPeer::DIAGNOSISTYPE_ID, $this->diagnosistype_id);
        if ($this->isColumnModified(DiagnosisPeer::CHARACTER_ID)) $criteria->add(DiagnosisPeer::CHARACTER_ID, $this->character_id);
        if ($this->isColumnModified(DiagnosisPeer::MKB)) $criteria->add(DiagnosisPeer::MKB, $this->mkb);
        if ($this->isColumnModified(DiagnosisPeer::MKBEX)) $criteria->add(DiagnosisPeer::MKBEX, $this->mkbex);
        if ($this->isColumnModified(DiagnosisPeer::DISPANSER_ID)) $criteria->add(DiagnosisPeer::DISPANSER_ID, $this->dispanser_id);
        if ($this->isColumnModified(DiagnosisPeer::TRAUMATYPE_ID)) $criteria->add(DiagnosisPeer::TRAUMATYPE_ID, $this->traumatype_id);
        if ($this->isColumnModified(DiagnosisPeer::SETDATE)) $criteria->add(DiagnosisPeer::SETDATE, $this->setdate);
        if ($this->isColumnModified(DiagnosisPeer::ENDDATE)) $criteria->add(DiagnosisPeer::ENDDATE, $this->enddate);
        if ($this->isColumnModified(DiagnosisPeer::MOD_ID)) $criteria->add(DiagnosisPeer::MOD_ID, $this->mod_id);
        if ($this->isColumnModified(DiagnosisPeer::PERSON_ID)) $criteria->add(DiagnosisPeer::PERSON_ID, $this->person_id);
    ...
    {
        $criteria = new Criteria(DiagnosisPeer::DATABASE_NAME);
        $criteria->add(DiagnosisPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Diagnosis (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMkbex($this->getMkbex());
        ...
        $copyObj->setModId($this->getModId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Diagnosis Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DiagnosisPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DiagnosisPeer();
        }
    ...
    {
        return (string) $this->exportTo(DiagnosisPeer::DEFAULT_STRING_FORMAT);
    }
