...
/**
 * Base class that represents a row from the 'rlsForm' table.
 *
 *
 *
 * @package    propel.generator.Models.om
 */
abstract class BaserlsForm extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\rlsFormPeer';
     ...
     * @return rlsForm The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = rlsFormPeer::ID;
        }
    ...
    public function setname($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = rlsFormPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = rlsFormPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating rlsForm object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = rlsFormPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = rlsFormQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                rlsFormPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(rlsFormPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(rlsFormPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `rlsForm` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = rlsFormPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = rlsFormPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['rlsForm'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['rlsForm'][$this->getPrimaryKey()] = true;
        $keys = rlsFormPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            $keys[1] => $this->getname(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(rlsFormPeer::ID)) $criteria->add(rlsFormPeer::ID, $this->id);
        if ($this->isColumnModified(rlsFormPeer::NAME)) $criteria->add(rlsFormPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(rlsFormPeer::DATABASE_NAME);
        $criteria->add(rlsFormPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of rlsForm (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return rlsForm Clone of current object.
     * @throws PropelException
     */
     ...
     * If this rlsForm is new, it will return
    ...
    public function setrlsNomens(PropelCollection $rlsNomens, PropelPDO $con = null)
    {
        ...
        foreach ($rlsNomensToDelete as $rlsNomenRemoved) {
            $rlsNomenRemoved->setrlsForm(null);
        }
     ...
     * Otherwise if this rlsForm is new, it will return
     * an empty collection; or if this rlsForm has previously
     * been saved, it will retrieve related rlsNomens from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in rlsForm.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(rlsFormPeer::DEFAULT_STRING_FORMAT);
    }
