...
use Webmis\Models\ClientcontactQuery;

/**
 * Base class that represents a row from the 'ClientContact' table.
 *
 *
 *
...
abstract class BaseClientcontact extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ClientcontactPeer';
    ...
    /**
     * The value for the contacttype_id field.
     * @var        int
     */
    protected $contacttype_id;
    ...
    /**
     * Initializes internal state of BaseClientcontact object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [contacttype_id] column value.
     *
     * @return int
     */
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientcontactPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientcontactPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientcontactPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientcontactPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = ClientcontactPeer::DELETED;
        }
    ...
    /**
     * Set the value of [contacttype_id] column.
     *
     * @param int $v new value
     * @return Clientcontact The current object (for fluent API support)
     */
    public function setContacttypeId($v)
    {
        ...
        if ($this->contacttype_id !== $v) {
            $this->contacttype_id = $v;
            $this->modifiedColumns[] = ClientcontactPeer::CONTACTTYPE_ID;
        }
    ...
    public function setContact($v)
    {
        ...
        if ($this->contact !== $v) {
            $this->contact = $v;
            $this->modifiedColumns[] = ClientcontactPeer::CONTACT;
        }
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[] = ClientcontactPeer::NOTES;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = ClientcontactPeer::VERSION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->contacttype_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->contact = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            ...
            return $startcol + 11; // 11 = ClientcontactPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClientcontactPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(ClientcontactPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(ClientcontactPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(ClientcontactPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(ClientcontactPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(ClientcontactPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(ClientcontactPeer::CONTACTTYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`contactType_id`';
        }
        if ($this->isColumnModified(ClientcontactPeer::CONTACT)) {
            $modifiedColumns[':p' . $index++]  = '`contact`';
        }
        if ($this->isColumnModified(ClientcontactPeer::NOTES)) {
            $modifiedColumns[':p' . $index++]  = '`notes`';
        }
        if ($this->isColumnModified(ClientcontactPeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`version`';
        }

        $sql = sprintf(
            'INSERT INTO `ClientContact` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`client_id`':
                        ...
                        break;
                    case '`contactType_id`':
                        $stmt->bindValue($identifier, $this->contacttype_id, PDO::PARAM_INT);
                        break;
                    case '`contact`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setContacttypeId($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setContact($arr[$keys[8]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientcontactPeer::CREATEDATETIME)) $criteria->add(ClientcontactPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(ClientcontactPeer::CREATEPERSON_ID)) $criteria->add(ClientcontactPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(ClientcontactPeer::MODIFYDATETIME)) $criteria->add(ClientcontactPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(ClientcontactPeer::MODIFYPERSON_ID)) $criteria->add(ClientcontactPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(ClientcontactPeer::DELETED)) $criteria->add(ClientcontactPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(ClientcontactPeer::CLIENT_ID)) $criteria->add(ClientcontactPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(ClientcontactPeer::CONTACTTYPE_ID)) $criteria->add(ClientcontactPeer::CONTACTTYPE_ID, $this->contacttype_id);
        if ($this->isColumnModified(ClientcontactPeer::CONTACT)) $criteria->add(ClientcontactPeer::CONTACT, $this->contact);
        if ($this->isColumnModified(ClientcontactPeer::NOTES)) $criteria->add(ClientcontactPeer::NOTES, $this->notes);
        if ($this->isColumnModified(ClientcontactPeer::VERSION)) $criteria->add(ClientcontactPeer::VERSION, $this->version);
