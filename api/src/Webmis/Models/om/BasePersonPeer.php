...
abstract class BasePersonPeer
{
    ...
    {
        // Invalidate objects in ActionpropertyPersonPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        ActionpropertyPersonPeer::clearInstancePool();
        // Invalidate objects in ActiontypePeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        ActiontypePeer::clearInstancePool();
        // Invalidate objects in NotificationoccurredPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        NotificationoccurredPeer::clearInstancePool();
        // Invalidate objects in StockmotionPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        StockmotionPeer::clearInstancePool();
        // Invalidate objects in StockmotionPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        StockmotionPeer::clearInstancePool();
        // Invalidate objects in StockrequisitionPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            // cloning the Criteria in case it's modified by doSelect() or doSelectStmt()
            $c = clone $criteria;
            PersonPeer::doOnDeleteSetNull($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related ActionpropertyPerson objects
            $criteria = new Criteria(ActionpropertyPersonPeer::DATABASE_NAME);

            $criteria->add(ActionpropertyPersonPeer::VALUE, $obj->getId());
            $affectedRows += ActionpropertyPersonPeer::doDelete($criteria, $con);

            // delete related Notificationoccurred objects
            $criteria = new Criteria(NotificationoccurredPeer::DATABASE_NAME);

            $criteria->add(NotificationoccurredPeer::USERID, $obj->getId());
            $affectedRows += NotificationoccurredPeer::doDelete($criteria, $con);
        }
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // set fkey col in related Actiontype rows to null
            $selectCriteria = new Criteria(PersonPeer::DATABASE_NAME);
            $updateValues = new Criteria(PersonPeer::DATABASE_NAME);
            $selectCriteria->add(ActiontypePeer::DEFAULTEXECPERSON_ID, $obj->getId());
            $updateValues->add(ActiontypePeer::DEFAULTEXECPERSON_ID, null);

            BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

            // set fkey col in related Stockmotion rows to null
            $selectCriteria = new Criteria(PersonPeer::DATABASE_NAME);
            $updateValues = new Criteria(PersonPeer::DATABASE_NAME);
            $selectCriteria->add(StockmotionPeer::RECEIVERPERSON_ID, $obj->getId());
            $updateValues->add(StockmotionPeer::RECEIVERPERSON_ID, null);
            ...
            $selectCriteria = new Criteria(PersonPeer::DATABASE_NAME);
            $updateValues = new Criteria(PersonPeer::DATABASE_NAME);
            $selectCriteria->add(StockmotionPeer::SUPPLIERPERSON_ID, $obj->getId());
            $updateValues->add(StockmotionPeer::SUPPLIERPERSON_ID, null);

            BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

            // set fkey col in related Stockrequisition rows to null
            $selectCriteria = new Criteria(PersonPeer::DATABASE_NAME);
            $updateValues = new Criteria(PersonPeer::DATABASE_NAME);
            $selectCriteria->add(StockrequisitionPeer::CREATEPERSON_ID, $obj->getId());
            $updateValues->add(StockrequisitionPeer::CREATEPERSON_ID, null);
            ...
            $selectCriteria = new Criteria(PersonPeer::DATABASE_NAME);
            $updateValues = new Criteria(PersonPeer::DATABASE_NAME);
            $selectCriteria->add(StockrequisitionPeer::MODIFYPERSON_ID, $obj->getId());
            $updateValues->add(StockrequisitionPeer::MODIFYPERSON_ID, null);
            ...
            $selectCriteria = new Criteria(PersonPeer::DATABASE_NAME);
            $updateValues = new Criteria(PersonPeer::DATABASE_NAME);
            $selectCriteria->add(TakentissuejournalPeer::EXECPERSON_ID, $obj->getId());
            $updateValues->add(TakentissuejournalPeer::EXECPERSON_ID, null);
