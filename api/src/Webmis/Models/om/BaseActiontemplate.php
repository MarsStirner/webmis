...
use Webmis\Models\ActiontemplateQuery;

/**
 * Base class that represents a row from the 'ActionTemplate' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseActiontemplate extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ActiontemplatePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ActiontemplatePeer
     */
     ...
     * @return Actiontemplate The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ActiontemplatePeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ActiontemplatePeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ActiontemplatePeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ActiontemplatePeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::DELETED;
        }
    ...
    public function setGroupId($v)
    {
        ...
        if ($this->group_id !== $v) {
            $this->group_id = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::GROUP_ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::CODE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::NAME;
        }
    ...
    public function setSex($v)
    {
        ...
        if ($this->sex !== $v) {
            $this->sex = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::SEX;
        }
    ...
    public function setAge($v)
    {
        ...
        if ($this->age !== $v) {
            $this->age = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::AGE;
        }
    ...
    public function setAgeBu($v)
    {
        ...
        if ($this->age_bu !== $v) {
            $this->age_bu = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::AGE_BU;
        }
    ...
    public function setAgeBc($v)
    {
        ...
        if ($this->age_bc !== $v) {
            $this->age_bc = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::AGE_BC;
        }
    ...
    public function setAgeEu($v)
    {
        ...
        if ($this->age_eu !== $v) {
            $this->age_eu = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::AGE_EU;
        }
    ...
    public function setAgeEc($v)
    {
        ...
        if ($this->age_ec !== $v) {
            $this->age_ec = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::AGE_EC;
        }
    ...
    public function setOwnerId($v)
    {
        ...
        if ($this->owner_id !== $v) {
            $this->owner_id = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::OWNER_ID;
        }
    ...
    public function setSpecialityId($v)
    {
        ...
        if ($this->speciality_id !== $v) {
            ...
            $this->modifiedColumns[] = ActiontemplatePeer::SPECIALITY_ID;
        }
    ...
    public function setActionId($v)
    {
        ...
        if ($this->action_id !== $v) {
            $this->action_id = $v;
            $this->modifiedColumns[] = ActiontemplatePeer::ACTION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->owner_id = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
            $this->speciality_id = ($row[$startcol + 16] !== null) ? (int) $row[$startcol + 16] : null;
            $this->action_id = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
            $this->resetModified();
            ...
            return $startcol + 18; // 18 = ActiontemplatePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Actiontemplate object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ActiontemplatePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ActiontemplateQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ActiontemplatePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ActiontemplatePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::GROUP_ID)) {
            $modifiedColumns[':p' . $index++]  = '`group_id`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::SEX)) {
            $modifiedColumns[':p' . $index++]  = '`sex`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::AGE)) {
            $modifiedColumns[':p' . $index++]  = '`age`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::AGE_BU)) {
            $modifiedColumns[':p' . $index++]  = '`age_bu`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::AGE_BC)) {
            $modifiedColumns[':p' . $index++]  = '`age_bc`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::AGE_EU)) {
            $modifiedColumns[':p' . $index++]  = '`age_eu`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::AGE_EC)) {
            $modifiedColumns[':p' . $index++]  = '`age_ec`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::OWNER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`owner_id`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::SPECIALITY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`speciality_id`';
        }
        if ($this->isColumnModified(ActiontemplatePeer::ACTION_ID)) {
            $modifiedColumns[':p' . $index++]  = '`action_id`';
        }

        $sql = sprintf(
            'INSERT INTO `ActionTemplate` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ActiontemplatePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ActiontemplatePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Actiontemplate'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Actiontemplate'][$this->getPrimaryKey()] = true;
        $keys = ActiontemplatePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            ...
            $keys[15] => $this->getOwnerId(),
            $keys[16] => $this->getSpecialityId(),
            $keys[17] => $this->getActionId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[15], $arr)) $this->setOwnerId($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setSpecialityId($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setActionId($arr[$keys[17]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ActiontemplatePeer::ID)) $criteria->add(ActiontemplatePeer::ID, $this->id);
        if ($this->isColumnModified(ActiontemplatePeer::CREATEDATETIME)) $criteria->add(ActiontemplatePeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(ActiontemplatePeer::CREATEPERSON_ID)) $criteria->add(ActiontemplatePeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(ActiontemplatePeer::MODIFYDATETIME)) $criteria->add(ActiontemplatePeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(ActiontemplatePeer::MODIFYPERSON_ID)) $criteria->add(ActiontemplatePeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(ActiontemplatePeer::DELETED)) $criteria->add(ActiontemplatePeer::DELETED, $this->deleted);
        if ($this->isColumnModified(ActiontemplatePeer::GROUP_ID)) $criteria->add(ActiontemplatePeer::GROUP_ID, $this->group_id);
        if ($this->isColumnModified(ActiontemplatePeer::CODE)) $criteria->add(ActiontemplatePeer::CODE, $this->code);
        if ($this->isColumnModified(ActiontemplatePeer::NAME)) $criteria->add(ActiontemplatePeer::NAME, $this->name);
        if ($this->isColumnModified(ActiontemplatePeer::SEX)) $criteria->add(ActiontemplatePeer::SEX, $this->sex);
        if ($this->isColumnModified(ActiontemplatePeer::AGE)) $criteria->add(ActiontemplatePeer::AGE, $this->age);
        if ($this->isColumnModified(ActiontemplatePeer::AGE_BU)) $criteria->add(ActiontemplatePeer::AGE_BU, $this->age_bu);
        if ($this->isColumnModified(ActiontemplatePeer::AGE_BC)) $criteria->add(ActiontemplatePeer::AGE_BC, $this->age_bc);
        if ($this->isColumnModified(ActiontemplatePeer::AGE_EU)) $criteria->add(ActiontemplatePeer::AGE_EU, $this->age_eu);
        if ($this->isColumnModified(ActiontemplatePeer::AGE_EC)) $criteria->add(ActiontemplatePeer::AGE_EC, $this->age_ec);
        if ($this->isColumnModified(ActiontemplatePeer::OWNER_ID)) $criteria->add(ActiontemplatePeer::OWNER_ID, $this->owner_id);
        if ($this->isColumnModified(ActiontemplatePeer::SPECIALITY_ID)) $criteria->add(ActiontemplatePeer::SPECIALITY_ID, $this->speciality_id);
        if ($this->isColumnModified(ActiontemplatePeer::ACTION_ID)) $criteria->add(ActiontemplatePeer::ACTION_ID, $this->action_id);
    ...
    {
        $criteria = new Criteria(ActiontemplatePeer::DATABASE_NAME);
        $criteria->add(ActiontemplatePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Actiontemplate (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Actiontemplate Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ActiontemplatePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ActiontemplatePeer();
        }
    ...
    {
        return (string) $this->exportTo(ActiontemplatePeer::DEFAULT_STRING_FORMAT);
    }
