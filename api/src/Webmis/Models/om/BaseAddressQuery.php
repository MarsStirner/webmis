...
use \PropelPDO;
use Webmis\Models\Address;
use Webmis\Models\AddressPeer;
use Webmis\Models\AddressQuery;
 ...
 * @method AddressQuery orderByCreatedatetime($order = Criteria::ASC) Order by the createDatetime column
 * @method AddressQuery orderByCreatepersonId($order = Criteria::ASC) Order by the createPerson_id column
 * @method AddressQuery orderByModifydatetime($order = Criteria::ASC) Order by the modifyDatetime column
 * @method AddressQuery orderByModifypersonId($order = Criteria::ASC) Order by the modifyPerson_id column
 * @method AddressQuery orderByDeleted($order = Criteria::ASC) Order by the deleted column
 * @method AddressQuery orderByHouseId($order = Criteria::ASC) Order by the house_id column
 * @method AddressQuery orderByFlat($order = Criteria::ASC) Order by the flat column
 *
 * @method AddressQuery groupById() Group by the id column
 * @method AddressQuery groupByCreatedatetime() Group by the createDatetime column
 * @method AddressQuery groupByCreatepersonId() Group by the createPerson_id column
 * @method AddressQuery groupByModifydatetime() Group by the modifyDatetime column
 * @method AddressQuery groupByModifypersonId() Group by the modifyPerson_id column
 * @method AddressQuery groupByDeleted() Group by the deleted column
 * @method AddressQuery groupByHouseId() Group by the house_id column
 * @method AddressQuery groupByFlat() Group by the flat column
 *
 ...
 *
 * @method Address findOneByCreatedatetime(string $createDatetime) Return the first Address filtered by the createDatetime column
 * @method Address findOneByCreatepersonId(int $createPerson_id) Return the first Address filtered by the createPerson_id column
 * @method Address findOneByModifydatetime(string $modifyDatetime) Return the first Address filtered by the modifyDatetime column
 * @method Address findOneByModifypersonId(int $modifyPerson_id) Return the first Address filtered by the modifyPerson_id column
 * @method Address findOneByDeleted(boolean $deleted) Return the first Address filtered by the deleted column
 * @method Address findOneByHouseId(int $house_id) Return the first Address filtered by the house_id column
 * @method Address findOneByFlat(string $flat) Return the first Address filtered by the flat column
 *
 * @method array findById(int $id) Return Address objects filtered by the id column
 * @method array findByCreatedatetime(string $createDatetime) Return Address objects filtered by the createDatetime column
 * @method array findByCreatepersonId(int $createPerson_id) Return Address objects filtered by the createPerson_id column
 * @method array findByModifydatetime(string $modifyDatetime) Return Address objects filtered by the modifyDatetime column
 * @method array findByModifypersonId(int $modifyPerson_id) Return Address objects filtered by the modifyPerson_id column
 * @method array findByDeleted(boolean $deleted) Return Address objects filtered by the deleted column
 * @method array findByHouseId(int $house_id) Return Address objects filtered by the house_id column
 * @method array findByFlat(string $flat) Return Address objects filtered by the flat column
 *
...
abstract class BaseAddressQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'Webmis-API', $modelName = 'Webmis\\Models\\Address', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `createDatetime`, `createPerson_id`, `modifyDatetime`, `modifyPerson_id`, `deleted`, `house_id`, `flat` FROM `Address` WHERE `id` = :p0';
        try {
    ...
    public function filterByCreatedatetime($createdatetime = null, $comparison = null)
    {
        if (is_array($createdatetime)) {
            ...
            if (isset($createdatetime['min'])) {
                $this->addUsingAlias(AddressPeer::CREATEDATETIME, $createdatetime['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdatetime['max'])) {
                $this->addUsingAlias(AddressPeer::CREATEDATETIME, $createdatetime['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AddressPeer::CREATEDATETIME, $createdatetime, $comparison);
    }
    ...
    public function filterByCreatepersonId($createpersonId = null, $comparison = null)
    {
        if (is_array($createpersonId)) {
            ...
            if (isset($createpersonId['min'])) {
                $this->addUsingAlias(AddressPeer::CREATEPERSON_ID, $createpersonId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createpersonId['max'])) {
                $this->addUsingAlias(AddressPeer::CREATEPERSON_ID, $createpersonId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AddressPeer::CREATEPERSON_ID, $createpersonId, $comparison);
    }
    ...
    public function filterByModifydatetime($modifydatetime = null, $comparison = null)
    {
        if (is_array($modifydatetime)) {
            ...
            if (isset($modifydatetime['min'])) {
                $this->addUsingAlias(AddressPeer::MODIFYDATETIME, $modifydatetime['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($modifydatetime['max'])) {
                $this->addUsingAlias(AddressPeer::MODIFYDATETIME, $modifydatetime['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AddressPeer::MODIFYDATETIME, $modifydatetime, $comparison);
    }
    ...
    public function filterByModifypersonId($modifypersonId = null, $comparison = null)
    {
        if (is_array($modifypersonId)) {
            ...
            if (isset($modifypersonId['min'])) {
                $this->addUsingAlias(AddressPeer::MODIFYPERSON_ID, $modifypersonId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($modifypersonId['max'])) {
                $this->addUsingAlias(AddressPeer::MODIFYPERSON_ID, $modifypersonId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AddressPeer::MODIFYPERSON_ID, $modifypersonId, $comparison);
    }
    ...
    public function filterByDeleted($deleted = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AddressPeer::DELETED, $deleted, $comparison);
    }
    ...
    public function filterByHouseId($houseId = null, $comparison = null)
    {
        if (is_array($houseId)) {
            ...
            if (isset($houseId['min'])) {
                $this->addUsingAlias(AddressPeer::HOUSE_ID, $houseId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($houseId['max'])) {
                $this->addUsingAlias(AddressPeer::HOUSE_ID, $houseId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(AddressPeer::HOUSE_ID, $houseId, $comparison);
    }
    ...
    public function filterByFlat($flat = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AddressPeer::FLAT, $flat, $comparison);
    }
