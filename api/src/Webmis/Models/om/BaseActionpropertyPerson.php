...
/**
 * Base class that represents a row from the 'ActionProperty_Person' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseActionpropertyPerson extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ActionpropertyPersonPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ActionpropertyPersonPeer
     */
    ...
    /**
     * Initializes internal state of BaseActionpropertyPerson object.
     * @see        applyDefaults()
     */
     ...
     * @return ActionpropertyPerson The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ActionpropertyPersonPeer::ID;
        }
    ...
    public function setIndex($v)
    {
        ...
        if ($this->index !== $v) {
            $this->index = $v;
            $this->modifiedColumns[] = ActionpropertyPersonPeer::INDEX;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = ActionpropertyPersonPeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ActionpropertyPersonPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ActionpropertyPerson object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPerson !== null && $this->value !== $this->aPerson->getId()) {
            $this->aPerson = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ActionpropertyPersonPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ActionpropertyPersonQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ActionpropertyPersonPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ActionpropertyPersonPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ActionpropertyPersonPeer::INDEX)) {
            $modifiedColumns[':p' . $index++]  = '`index`';
        }
        if ($this->isColumnModified(ActionpropertyPersonPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }

        $sql = sprintf(
            'INSERT INTO `ActionProperty_Person` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ActionpropertyPersonPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ActionpropertyPersonPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ActionpropertyPerson'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ActionpropertyPerson'][serialize($this->getPrimaryKey())] = true;
        $keys = ActionpropertyPersonPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ActionpropertyPersonPeer::ID)) $criteria->add(ActionpropertyPersonPeer::ID, $this->id);
        if ($this->isColumnModified(ActionpropertyPersonPeer::INDEX)) $criteria->add(ActionpropertyPersonPeer::INDEX, $this->index);
        if ($this->isColumnModified(ActionpropertyPersonPeer::VALUE)) $criteria->add(ActionpropertyPersonPeer::VALUE, $this->value);
    ...
    {
        $criteria = new Criteria(ActionpropertyPersonPeer::DATABASE_NAME);
        $criteria->add(ActionpropertyPersonPeer::ID, $this->id);
        $criteria->add(ActionpropertyPersonPeer::INDEX, $this->index);
     ...
     * objects.
     *
     * @param object $copyObj An object of ActionpropertyPerson (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ActionpropertyPerson Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ActionpropertyPersonPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ActionpropertyPersonPeer();
        }
    ...
    public function setActionproperty(Actionproperty $v = null)
    {
        ...
        if ($v !== null) {
            $v->addActionpropertyPerson($this);
        }
    ...
    public function getActionproperty(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aActionproperty === null && ($this->id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aActionproperty->addActionpropertyPersons($this);
             */
        }
    ...
    {
        if ($this->aPerson === null && ($this->value !== null) && $doQuery) {
            $this->aPerson = PersonQuery::create()->findPk($this->value, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPerson->addActionpropertyPersons($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ActionpropertyPersonPeer::DEFAULT_STRING_FORMAT);
    }
