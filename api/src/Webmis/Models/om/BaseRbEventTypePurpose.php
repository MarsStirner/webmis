...
abstract class BaseRbEventTypePurpose extends BaseObject implements Persistent
{
    ...
    public function setEventTypes(PropelCollection $eventTypes, PropelPDO $con = null)
    {
        ...
        foreach ($eventTypesToDelete as $eventTypeRemoved) {
            $eventTypeRemoved->setRbEventTypePurpose(null);
        }
    ...
    protected function doAddEventType($eventType)
    {
        ...
        $eventType->setRbEventTypePurpose($this);
    }
    ...
    public function removeEventType($eventType)
    {
        if ($this->getEventTypes()->contains($eventType)) {
            ...
            $eventType->setRbEventTypePurpose(null);
        }
     ...
     * Otherwise if this RbEventTypePurpose is new, it will return
     * an empty collection; or if this RbEventTypePurpose has previously
     * been saved, it will retrieve related EventTypes from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RbEventTypePurpose.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|EventType[] List of EventType objects
     */
    public function getEventTypesJoinRbResult($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = EventTypeQuery::create(null, $criteria);
        $query->joinWith('RbResult', $join_behavior);
