 ...
 *
 * @method ActionPropertyDoubleQuery leftJoinActionProperty($relationAlias = null) Adds a LEFT JOIN clause to the query using the ActionProperty relation
 * @method ActionPropertyDoubleQuery rightJoinActionProperty($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ActionProperty relation
 * @method ActionPropertyDoubleQuery innerJoinActionProperty($relationAlias = null) Adds a INNER JOIN clause to the query using the ActionProperty relation
 *
...
abstract class BaseActionPropertyDoubleQuery extends ModelCriteria
{
    ...
    public function filterByActionProperty($actionProperty, $comparison = null)
    {
        if ($actionProperty instanceof ActionProperty) {
            return $this
                ->addUsingAlias(ActionPropertyDoublePeer::ID, $actionProperty->getid(), $comparison);
            ...
            return $this
                ->addUsingAlias(ActionPropertyDoublePeer::ID, $actionProperty->toKeyValue('PrimaryKey', 'id'), $comparison);
        } else {
