...
/**
 * Base class that represents a row from the 'ActionProperty_Time' table.
 *
 *
 *
 * @package    propel.generator.Models.om
 */
abstract class BaseActionPropertyTime extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ActionPropertyTimePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ActionPropertyTimePeer
     */
    ...
    /**
     * Initializes internal state of BaseActionPropertyTime object.
     * @see        applyDefaults()
     */
     ...
     */
    public function getialue($format = '%X')
    {
        if ($this->value === null) {
            return null;
        }
     ...
     * @return ActionPropertyTime The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ActionPropertyTimePeer::ID;
        }
    ...
    public function setindex($v)
    {
        ...
        if ($this->index !== $v) {
            $this->index = $v;
            $this->modifiedColumns[] = ActionPropertyTimePeer::INDEX;
        }
     ...
     * @return ActionPropertyTime The current object (for fluent API support)
     */
    public function setialue($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->value !== null || $dt !== null) {
            $currentDateAsString = ($this->value !== null && $tmpDt = new DateTime($this->value)) ? $tmpDt->format('H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->value = $newDateAsString;
                $this->modifiedColumns[] = ActionPropertyTimePeer::VALUE;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ActionPropertyTimePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ActionPropertyTime object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ActionPropertyTimePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ActionPropertyTimeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ActionPropertyTimePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ActionPropertyTimePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ActionPropertyTimePeer::INDEX)) {
            $modifiedColumns[':p' . $index++]  = '`index`';
        }
        if ($this->isColumnModified(ActionPropertyTimePeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }

        $sql = sprintf(
            'INSERT INTO `ActionProperty_Time` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ActionPropertyTimePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ActionPropertyTimePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ActionPropertyTime'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ActionPropertyTime'][serialize($this->getPrimaryKey())] = true;
        $keys = ActionPropertyTimePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            $keys[1] => $this->getindex(),
            $keys[2] => $this->getialue(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setialue($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ActionPropertyTimePeer::ID)) $criteria->add(ActionPropertyTimePeer::ID, $this->id);
        if ($this->isColumnModified(ActionPropertyTimePeer::INDEX)) $criteria->add(ActionPropertyTimePeer::INDEX, $this->index);
        if ($this->isColumnModified(ActionPropertyTimePeer::VALUE)) $criteria->add(ActionPropertyTimePeer::VALUE, $this->value);
    ...
    {
        $criteria = new Criteria(ActionPropertyTimePeer::DATABASE_NAME);
        $criteria->add(ActionPropertyTimePeer::ID, $this->id);
        $criteria->add(ActionPropertyTimePeer::INDEX, $this->index);
     ...
     * objects.
     *
     * @param object $copyObj An object of ActionPropertyTime (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setialue($this->getialue());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ActionPropertyTime Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ActionPropertyTimePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ActionPropertyTimePeer();
        }
    ...
    public function getActionProperty(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aActionProperty === null && ($this->id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aActionProperty->addActionPropertyTimes($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ActionPropertyTimePeer::DEFAULT_STRING_FORMAT);
    }
