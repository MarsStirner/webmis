...
/**
 * Base class that represents a row from the 'ActionProperty_Integer' table.
 *
 *
 *
 * @package    propel.generator.Models.om
 */
abstract class BaseActionPropertyInteger extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ActionPropertyIntegerPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ActionPropertyIntegerPeer
     */
    ...
    /**
     * Initializes internal state of BaseActionPropertyInteger object.
     * @see        applyDefaults()
     */
    ...
    public function setindex($v)
    {
        ...
        if ($this->index !== $v) {
            $this->index = $v;
            $this->modifiedColumns[] = ActionPropertyIntegerPeer::INDEX;
        }
    ...
    public function setvalue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = ActionPropertyIntegerPeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ActionPropertyIntegerPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ActionPropertyInteger object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ActionPropertyIntegerPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ActionPropertyIntegerQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ActionPropertyIntegerPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ActionPropertyIntegerPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ActionPropertyIntegerPeer::INDEX)) {
            $modifiedColumns[':p' . $index++]  = '`index`';
        }
        if ($this->isColumnModified(ActionPropertyIntegerPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '`value`';
        }

        $sql = sprintf(
            'INSERT INTO `ActionProperty_Integer` (%s) VALUES (%s)',
    ...
    {
        $pos = ActionPropertyIntegerPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ActionPropertyInteger'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ActionPropertyInteger'][serialize($this->getPrimaryKey())] = true;
        $keys = ActionPropertyIntegerPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ActionPropertyIntegerPeer::ID)) $criteria->add(ActionPropertyIntegerPeer::ID, $this->id);
        if ($this->isColumnModified(ActionPropertyIntegerPeer::INDEX)) $criteria->add(ActionPropertyIntegerPeer::INDEX, $this->index);
        if ($this->isColumnModified(ActionPropertyIntegerPeer::VALUE)) $criteria->add(ActionPropertyIntegerPeer::VALUE, $this->value);
    ...
    {
        $criteria = new Criteria(ActionPropertyIntegerPeer::DATABASE_NAME);
        $criteria->add(ActionPropertyIntegerPeer::ID, $this->id);
        $criteria->add(ActionPropertyIntegerPeer::INDEX, $this->index);
     ...
     * objects.
     *
     * @param object $copyObj An object of ActionPropertyInteger (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ActionPropertyInteger Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ActionPropertyIntegerPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ActionPropertyIntegerPeer();
        }
    ...
    {
        return (string) $this->exportTo(ActionPropertyIntegerPeer::DEFAULT_STRING_FORMAT);
    }
