...
use Webmis\Models\map\ApplockTableMap;

/**
 * Base static class for performing query and update operations on the 'AppLock' table.
 *
 *
 *
...
abstract class BaseApplockPeer
{
    ...
    const TABLE_NAME = 'AppLock';

    /** the related Propel class for this table */
    const OM_CLASS = 'Webmis\\Models\\Applock';

    /** the related TableMap class for this table */
    const TM_CLASS = 'ApplockTableMap';
    ...
    /** the column name for the lockTime field */
    const LOCKTIME = 'AppLock.lockTime';

    /** the column name for the retTime field */
    const RETTIME = 'AppLock.retTime';

    /** the column name for the connectionId field */
    const CONNECTIONID = 'AppLock.connectionId';

    /** the column name for the person_id field */
    const PERSON_ID = 'AppLock.person_id';

    /** the column name for the addr field */
    const ADDR = 'AppLock.addr';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of Applock objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Locktime', 'Rettime', 'Connectionid', 'PersonId', 'Addr', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'locktime', 'rettime', 'connectionid', 'personId', 'addr', ),
        BasePeer::TYPE_COLNAME => array (ApplockPeer::ID, ApplockPeer::LOCKTIME, ApplockPeer::RETTIME, ApplockPeer::CONNECTIONID, ApplockPeer::PERSON_ID, ApplockPeer::ADDR, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'LOCKTIME', 'RETTIME', 'CONNECTIONID', 'PERSON_ID', 'ADDR', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'lockTime', 'retTime', 'connectionId', 'person_id', 'addr', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Locktime' => 1, 'Rettime' => 2, 'Connectionid' => 3, 'PersonId' => 4, 'Addr' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'locktime' => 1, 'rettime' => 2, 'connectionid' => 3, 'personId' => 4, 'addr' => 5, ),
        BasePeer::TYPE_COLNAME => array (ApplockPeer::ID => 0, ApplockPeer::LOCKTIME => 1, ApplockPeer::RETTIME => 2, ApplockPeer::CONNECTIONID => 3, ApplockPeer::PERSON_ID => 4, ApplockPeer::ADDR => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'LOCKTIME' => 1, 'RETTIME' => 2, 'CONNECTIONID' => 3, 'PERSON_ID' => 4, 'ADDR' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'lockTime' => 1, 'retTime' => 2, 'connectionId' => 3, 'person_id' => 4, 'addr' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ApplockPeer::ID);
            $criteria->addSelectColumn(ApplockPeer::LOCKTIME);
            $criteria->addSelectColumn(ApplockPeer::RETTIME);
            $criteria->addSelectColumn(ApplockPeer::CONNECTIONID);
            $criteria->addSelectColumn(ApplockPeer::PERSON_ID);
            $criteria->addSelectColumn(ApplockPeer::ADDR);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.lockTime');
            $criteria->addSelectColumn($alias . '.retTime');
            $criteria->addSelectColumn($alias . '.connectionId');
    ...
    /**
     * Method to invalidate the instance pool of all tables related to AppLock
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseApplockPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new ApplockTableMap());
      }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ApplockPeer::ID) && $criteria->keyContainsValue(ApplockPeer::ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ApplockPeer::ID);
            $value = $criteria->remove(ApplockPeer::ID);
            if ($value) {
                $selectCriteria->add(ApplockPeer::ID, $value, $comparison);
            } else {
    ...
    /**
     * Deletes all rows from the AppLock table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ApplockPeer::ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ApplockPeer::DATABASE_NAME);
        $criteria->add(ApplockPeer::ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ApplockPeer::DATABASE_NAME);
            $criteria->add(ApplockPeer::ID, $pks, Criteria::IN);
