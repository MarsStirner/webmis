...
abstract class BaseClientaddress extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ClientaddressPeer';
    ...
    /**
     * Initializes internal state of BaseClientaddress object.
     * @see        applyDefaults()
     */
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientaddressPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientaddressPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientaddressPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientaddressPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = ClientaddressPeer::DELETED;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = ClientaddressPeer::CLIENT_ID;
        }
    ...
    public function setAddressId($v)
    {
        ...
        if ($this->address_id !== $v) {
            $this->address_id = $v;
            $this->modifiedColumns[] = ClientaddressPeer::ADDRESS_ID;
        }
    ...
    public function setFreeinput($v)
    {
        ...
        if ($this->freeinput !== $v) {
            $this->freeinput = $v;
            $this->modifiedColumns[] = ClientaddressPeer::FREEINPUT;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = ClientaddressPeer::VERSION;
        }
    ...
    public function setLocalitytype($v)
    {
        ...
        if ($this->localitytype !== $v) {
            $this->localitytype = $v;
            $this->modifiedColumns[] = ClientaddressPeer::LOCALITYTYPE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->freeinput = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->version = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
            $this->localitytype = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClientaddressPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ClientaddressPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(ClientaddressPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(ClientaddressPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(ClientaddressPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(ClientaddressPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(ClientaddressPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(ClientaddressPeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(ClientaddressPeer::ADDRESS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`address_id`';
        }
        if ($this->isColumnModified(ClientaddressPeer::FREEINPUT)) {
            $modifiedColumns[':p' . $index++]  = '`freeInput`';
        }
        if ($this->isColumnModified(ClientaddressPeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`version`';
        }
        if ($this->isColumnModified(ClientaddressPeer::LOCALITYTYPE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`version`':
                        ...
                        break;
                    case '`localityType`':
                        $stmt->bindValue($identifier, $this->localitytype, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[9] => $this->getFreeinput(),
            $keys[10] => $this->getVersion(),
            $keys[11] => $this->getLocalitytype(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[9], $arr)) $this->setFreeinput($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setVersion($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setLocalitytype($arr[$keys[11]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientaddressPeer::CREATEDATETIME)) $criteria->add(ClientaddressPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(ClientaddressPeer::CREATEPERSON_ID)) $criteria->add(ClientaddressPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(ClientaddressPeer::MODIFYDATETIME)) $criteria->add(ClientaddressPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(ClientaddressPeer::MODIFYPERSON_ID)) $criteria->add(ClientaddressPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(ClientaddressPeer::DELETED)) $criteria->add(ClientaddressPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(ClientaddressPeer::CLIENT_ID)) $criteria->add(ClientaddressPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(ClientaddressPeer::TYPE)) $criteria->add(ClientaddressPeer::TYPE, $this->type);
        if ($this->isColumnModified(ClientaddressPeer::ADDRESS_ID)) $criteria->add(ClientaddressPeer::ADDRESS_ID, $this->address_id);
        if ($this->isColumnModified(ClientaddressPeer::FREEINPUT)) $criteria->add(ClientaddressPeer::FREEINPUT, $this->freeinput);
        if ($this->isColumnModified(ClientaddressPeer::VERSION)) $criteria->add(ClientaddressPeer::VERSION, $this->version);
        if ($this->isColumnModified(ClientaddressPeer::LOCALITYTYPE)) $criteria->add(ClientaddressPeer::LOCALITYTYPE, $this->localitytype);
