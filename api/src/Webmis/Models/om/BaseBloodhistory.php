...
/**
 * Base class that represents a row from the 'BloodHistory' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseBloodhistory extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\BloodhistoryPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BloodhistoryPeer
     */
     ...
     * @return Bloodhistory The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = BloodhistoryPeer::ID;
        }
    ...
    public function setBlooddate($v)
    {
        ...
        if ($this->blooddate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BloodhistoryPeer::BLOODDATE;
            }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = BloodhistoryPeer::CLIENT_ID;
        }
    ...
    public function setBloodtypeId($v)
    {
        ...
        if ($this->bloodtype_id !== $v) {
            $this->bloodtype_id = $v;
            $this->modifiedColumns[] = BloodhistoryPeer::BLOODTYPE_ID;
        }
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = BloodhistoryPeer::PERSON_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->blooddate = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->client_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->bloodtype_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 5; // 5 = BloodhistoryPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Bloodhistory object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BloodhistoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BloodhistoryQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BloodhistoryPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BloodhistoryPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(BloodhistoryPeer::BLOODDATE)) {
            $modifiedColumns[':p' . $index++]  = '`bloodDate`';
        }
        if ($this->isColumnModified(BloodhistoryPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(BloodhistoryPeer::BLOODTYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`bloodType_id`';
        }
        if ($this->isColumnModified(BloodhistoryPeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`person_id`';
        }

        $sql = sprintf(
            'INSERT INTO `BloodHistory` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BloodhistoryPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BloodhistoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Bloodhistory'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Bloodhistory'][$this->getPrimaryKey()] = true;
        $keys = BloodhistoryPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getBlooddate(),
            $keys[2] => $this->getClientId(),
            $keys[3] => $this->getBloodtypeId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setBlooddate($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setClientId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setBloodtypeId($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BloodhistoryPeer::ID)) $criteria->add(BloodhistoryPeer::ID, $this->id);
        if ($this->isColumnModified(BloodhistoryPeer::BLOODDATE)) $criteria->add(BloodhistoryPeer::BLOODDATE, $this->blooddate);
        if ($this->isColumnModified(BloodhistoryPeer::CLIENT_ID)) $criteria->add(BloodhistoryPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(BloodhistoryPeer::BLOODTYPE_ID)) $criteria->add(BloodhistoryPeer::BLOODTYPE_ID, $this->bloodtype_id);
        if ($this->isColumnModified(BloodhistoryPeer::PERSON_ID)) $criteria->add(BloodhistoryPeer::PERSON_ID, $this->person_id);
    ...
    {
        $criteria = new Criteria(BloodhistoryPeer::DATABASE_NAME);
        $criteria->add(BloodhistoryPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Bloodhistory (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Bloodhistory Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BloodhistoryPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BloodhistoryPeer();
        }
    ...
    {
        return (string) $this->exportTo(BloodhistoryPeer::DEFAULT_STRING_FORMAT);
    }
