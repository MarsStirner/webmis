 ...
 */
abstract class BaseActionPropertyString extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ActionPropertyStringPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ActionPropertyStringPeer
     */
    ...
    /**
     * Initializes internal state of BaseActionPropertyString object.
     * @see        applyDefaults()
     */
     ...
     * @return ActionPropertyString The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ActionPropertyStringPeer::ID;
        }
    ...
    public function setindex($v)
    {
        ...
        if ($this->index !== $v) {
            $this->index = $v;
            $this->modifiedColumns[] = ActionPropertyStringPeer::INDEX;
        }
    ...
    public function setvalue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = ActionPropertyStringPeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ActionPropertyStringPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ActionPropertyString object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ActionPropertyStringPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ActionPropertyStringQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ActionPropertyStringPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ActionPropertyStringPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ActionPropertyStringPeer::INDEX)) {
            $modifiedColumns[':p' . $index++]  = '`index`';
        }
        if ($this->isColumnModified(ActionPropertyStringPeer::VALUE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ActionPropertyStringPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ActionPropertyStringPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ActionPropertyString'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ActionPropertyString'][serialize($this->getPrimaryKey())] = true;
        $keys = ActionPropertyStringPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ActionPropertyStringPeer::ID)) $criteria->add(ActionPropertyStringPeer::ID, $this->id);
        if ($this->isColumnModified(ActionPropertyStringPeer::INDEX)) $criteria->add(ActionPropertyStringPeer::INDEX, $this->index);
        if ($this->isColumnModified(ActionPropertyStringPeer::VALUE)) $criteria->add(ActionPropertyStringPeer::VALUE, $this->value);
    ...
    {
        $criteria = new Criteria(ActionPropertyStringPeer::DATABASE_NAME);
        $criteria->add(ActionPropertyStringPeer::ID, $this->id);
        $criteria->add(ActionPropertyStringPeer::INDEX, $this->index);
     ...
     * objects.
     *
     * @param object $copyObj An object of ActionPropertyString (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ActionPropertyString Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ActionPropertyStringPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ActionPropertyStringPeer();
        }
    ...
    public function setActionProperty(ActionProperty $v = null)
    {
        ...
        if ($v !== null && $v->getActionPropertyString(null, false) === null) {
            $v->setActionPropertyString($this);
        }
    ...
    {
        return (string) $this->exportTo(ActionPropertyStringPeer::DEFAULT_STRING_FORMAT);
    }
