 ...
 * @method rlsTradeNameQuery orderBylocalName($order = Criteria::ASC) Order by the localName column
 *
 * @method rlsTradeNameQuery groupByid() Group by the id column
 * @method rlsTradeNameQuery groupByname() Group by the name column
 * @method rlsTradeNameQuery groupBylocalName() Group by the localName column
 *
 ...
 *
 * @method rlsTradeNameQuery leftJoinrlsNomen($relationAlias = null) Adds a LEFT JOIN clause to the query using the rlsNomen relation
 * @method rlsTradeNameQuery rightJoinrlsNomen($relationAlias = null) Adds a RIGHT JOIN clause to the query using the rlsNomen relation
 * @method rlsTradeNameQuery innerJoinrlsNomen($relationAlias = null) Adds a INNER JOIN clause to the query using the rlsNomen relation
 *
 ...
 * @method rlsTradeName findOneBylocalName(string $localName) Return the first rlsTradeName filtered by the localName column
 *
 ...
 * @method array findBylocalName(string $localName) Return rlsTradeName objects filtered by the localName column
 *
...
abstract class BaserlsTradeNameQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `name`, `localName` FROM `rlsTradeName` WHERE `id` = :p0';
        try {
