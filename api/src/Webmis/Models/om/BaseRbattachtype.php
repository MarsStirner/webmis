...
/**
 * Base class that represents a row from the 'rbAttachType' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseRbattachtype extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbattachtypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RbattachtypePeer
     */
     ...
     * @return Rbattachtype The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbattachtypePeer::ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = RbattachtypePeer::CODE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbattachtypePeer::NAME;
        }
    ...
    public function setTemporary($v)
    {
        ...
        if ($this->temporary !== $v) {
            $this->temporary = $v;
            $this->modifiedColumns[] = RbattachtypePeer::TEMPORARY;
        }
    ...
    public function setOutcome($v)
    {
        ...
        if ($this->outcome !== $v) {
            $this->outcome = $v;
            $this->modifiedColumns[] = RbattachtypePeer::OUTCOME;
        }
    ...
    public function setFinanceId($v)
    {
        ...
        if ($this->finance_id !== $v) {
            $this->finance_id = $v;
            $this->modifiedColumns[] = RbattachtypePeer::FINANCE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->temporary = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            $this->outcome = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->finance_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = RbattachtypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Rbattachtype object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbattachtypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbattachtypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbattachtypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->orgstructureDisabledattendancesScheduledForDeletion !== null) {
                if (!$this->orgstructureDisabledattendancesScheduledForDeletion->isEmpty()) {
                    foreach ($this->orgstructureDisabledattendancesScheduledForDeletion as $orgstructureDisabledattendance) {
                        // need to save related object because we set the relation to null
                        $orgstructureDisabledattendance->save($con);
                    }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbattachtypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbattachtypePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(RbattachtypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(RbattachtypePeer::TEMPORARY)) {
            $modifiedColumns[':p' . $index++]  = '`temporary`';
        }
        if ($this->isColumnModified(RbattachtypePeer::OUTCOME)) {
            $modifiedColumns[':p' . $index++]  = '`outcome`';
        }
        if ($this->isColumnModified(RbattachtypePeer::FINANCE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`finance_id`';
        }

        $sql = sprintf(
            'INSERT INTO `rbAttachType` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbattachtypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbattachtypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Rbattachtype'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Rbattachtype'][$this->getPrimaryKey()] = true;
        $keys = RbattachtypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getTemporary(),
            $keys[4] => $this->getOutcome(),
            $keys[5] => $this->getFinanceId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setTemporary($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setOutcome($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setFinanceId($arr[$keys[5]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbattachtypePeer::ID)) $criteria->add(RbattachtypePeer::ID, $this->id);
        if ($this->isColumnModified(RbattachtypePeer::CODE)) $criteria->add(RbattachtypePeer::CODE, $this->code);
        if ($this->isColumnModified(RbattachtypePeer::NAME)) $criteria->add(RbattachtypePeer::NAME, $this->name);
        if ($this->isColumnModified(RbattachtypePeer::TEMPORARY)) $criteria->add(RbattachtypePeer::TEMPORARY, $this->temporary);
        if ($this->isColumnModified(RbattachtypePeer::OUTCOME)) $criteria->add(RbattachtypePeer::OUTCOME, $this->outcome);
        if ($this->isColumnModified(RbattachtypePeer::FINANCE_ID)) $criteria->add(RbattachtypePeer::FINANCE_ID, $this->finance_id);
    ...
    {
        $criteria = new Criteria(RbattachtypePeer::DATABASE_NAME);
        $criteria->add(RbattachtypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Rbattachtype (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Rbattachtype Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbattachtypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbattachtypePeer();
        }
     ...
     * If this Rbattachtype is new, it will return
    ...
    public function setOrgstructureDisabledattendances(PropelCollection $orgstructureDisabledattendances, PropelPDO $con = null)
    {
        ...
        foreach ($orgstructureDisabledattendancesToDelete as $orgstructureDisabledattendanceRemoved) {
            $orgstructureDisabledattendanceRemoved->setRbattachtype(null);
        }
    ...
    protected function doAddOrgstructureDisabledattendance($orgstructureDisabledattendance)
    {
        ...
        $orgstructureDisabledattendance->setRbattachtype($this);
    }
    ...
    public function removeOrgstructureDisabledattendance($orgstructureDisabledattendance)
    {
        if ($this->getOrgstructureDisabledattendances()->contains($orgstructureDisabledattendance)) {
            ...
            $this->orgstructureDisabledattendancesScheduledForDeletion[]= $orgstructureDisabledattendance;
            $orgstructureDisabledattendance->setRbattachtype(null);
        }
     ...
     * Otherwise if this Rbattachtype is new, it will return
     * an empty collection; or if this Rbattachtype has previously
     * been saved, it will retrieve related OrgstructureDisabledattendances from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Rbattachtype.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|OrgstructureDisabledattendance[] List of OrgstructureDisabledattendance objects
     */
    public function getOrgstructureDisabledattendancesJoinOrgstructure($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = OrgstructureDisabledattendanceQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(RbattachtypePeer::DEFAULT_STRING_FORMAT);
    }
