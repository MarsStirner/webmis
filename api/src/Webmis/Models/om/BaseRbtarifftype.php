...
/**
 * Base class that represents a row from the 'rbTariffType' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseRbtarifftype extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbtarifftypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RbtarifftypePeer
     */
     ...
     * @return Rbtarifftype The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbtarifftypePeer::ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = RbtarifftypePeer::CODE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbtarifftypePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = RbtarifftypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Rbtarifftype object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbtarifftypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbtarifftypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbtarifftypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbtarifftypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbtarifftypePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(RbtarifftypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `rbTariffType` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbtarifftypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbtarifftypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Rbtarifftype'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Rbtarifftype'][$this->getPrimaryKey()] = true;
        $keys = RbtarifftypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCode(),
            $keys[2] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbtarifftypePeer::ID)) $criteria->add(RbtarifftypePeer::ID, $this->id);
        if ($this->isColumnModified(RbtarifftypePeer::CODE)) $criteria->add(RbtarifftypePeer::CODE, $this->code);
        if ($this->isColumnModified(RbtarifftypePeer::NAME)) $criteria->add(RbtarifftypePeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(RbtarifftypePeer::DATABASE_NAME);
        $criteria->add(RbtarifftypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Rbtarifftype (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Rbtarifftype Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbtarifftypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbtarifftypePeer();
        }
     ...
     * If this Rbtarifftype is new, it will return
    ...
    public function setMedicalkindunits(PropelCollection $medicalkindunits, PropelPDO $con = null)
    {
        ...
        foreach ($medicalkindunitsToDelete as $medicalkindunitRemoved) {
            $medicalkindunitRemoved->setRbtarifftype(null);
        }
    ...
    protected function doAddMedicalkindunit($medicalkindunit)
    {
        ...
        $medicalkindunit->setRbtarifftype($this);
    }
    ...
    public function removeMedicalkindunit($medicalkindunit)
    {
        if ($this->getMedicalkindunits()->contains($medicalkindunit)) {
            ...
            $medicalkindunit->setRbtarifftype(null);
        }
     ...
     * Otherwise if this Rbtarifftype is new, it will return
     * an empty collection; or if this Rbtarifftype has previously
     * been saved, it will retrieve related Medicalkindunits from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Rbtarifftype.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(RbtarifftypePeer::DEFAULT_STRING_FORMAT);
    }
