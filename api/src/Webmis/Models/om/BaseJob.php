...
abstract class BaseJob extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\JobPeer';
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JobPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = JobPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JobPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = JobPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = JobPeer::DELETED;
        }
    ...
    public function setJobtypeId($v)
    {
        ...
        if ($this->jobtype_id !== $v) {
            $this->jobtype_id = $v;
            $this->modifiedColumns[] = JobPeer::JOBTYPE_ID;
        }
    ...
    public function setOrgstructureId($v)
    {
        ...
        if ($this->orgstructure_id !== $v) {
            ...
            $this->modifiedColumns[] = JobPeer::ORGSTRUCTURE_ID;
        }
    ...
    public function setBegtime($v)
    {
        ...
        if ($this->begtime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JobPeer::BEGTIME;
            }
        } // if either are not null
    ...
    public function setEndtime($v)
    {
        ...
        if ($this->endtime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = JobPeer::ENDTIME;
            }
        } // if either are not null
    ...
    public function setQuantity($v)
    {
        ...
        if ($this->quantity !== $v) {
            $this->quantity = $v;
            $this->modifiedColumns[] = JobPeer::QUANTITY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->jobtype_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
            $this->orgstructure_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->date = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->begtime = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->endtime = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            ...
            return $startcol + 12; // 12 = JobPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(JobPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(JobPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(JobPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(JobPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(JobPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(JobPeer::JOBTYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`jobType_id`';
        }
        if ($this->isColumnModified(JobPeer::ORGSTRUCTURE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`orgStructure_id`';
        }
        if ($this->isColumnModified(JobPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(JobPeer::BEGTIME)) {
            $modifiedColumns[':p' . $index++]  = '`begTime`';
        }
        if ($this->isColumnModified(JobPeer::ENDTIME)) {
            $modifiedColumns[':p' . $index++]  = '`endTime`';
        }
        if ($this->isColumnModified(JobPeer::QUANTITY)) {
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getJobtypeId(),
            $keys[7] => $this->getOrgstructureId(),
            $keys[8] => $this->getDate(),
            $keys[9] => $this->getBegtime(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setJobtypeId($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setOrgstructureId($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setDate($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setBegtime($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setEndtime($arr[$keys[10]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(JobPeer::CREATEDATETIME)) $criteria->add(JobPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(JobPeer::CREATEPERSON_ID)) $criteria->add(JobPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(JobPeer::MODIFYDATETIME)) $criteria->add(JobPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(JobPeer::MODIFYPERSON_ID)) $criteria->add(JobPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(JobPeer::DELETED)) $criteria->add(JobPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(JobPeer::JOBTYPE_ID)) $criteria->add(JobPeer::JOBTYPE_ID, $this->jobtype_id);
        if ($this->isColumnModified(JobPeer::ORGSTRUCTURE_ID)) $criteria->add(JobPeer::ORGSTRUCTURE_ID, $this->orgstructure_id);
        if ($this->isColumnModified(JobPeer::DATE)) $criteria->add(JobPeer::DATE, $this->date);
        if ($this->isColumnModified(JobPeer::BEGTIME)) $criteria->add(JobPeer::BEGTIME, $this->begtime);
        if ($this->isColumnModified(JobPeer::ENDTIME)) $criteria->add(JobPeer::ENDTIME, $this->endtime);
        if ($this->isColumnModified(JobPeer::QUANTITY)) $criteria->add(JobPeer::QUANTITY, $this->quantity);
