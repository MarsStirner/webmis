...
/**
 * Base class that represents a row from the 'rlsTradeName' table.
 *
 *
 *
 * @package    propel.generator.Models.om
 */
abstract class BaserlsTradeName extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\rlsTradeNamePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        rlsTradeNamePeer
     */
     ...
     * @return rlsTradeName The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = rlsTradeNamePeer::ID;
        }
    ...
    public function setname($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = rlsTradeNamePeer::NAME;
        }
    ...
    public function setlocalName($v)
    {
        ...
        if ($this->localname !== $v) {
            $this->localname = $v;
            $this->modifiedColumns[] = rlsTradeNamePeer::LOCALNAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->localname = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = rlsTradeNamePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating rlsTradeName object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = rlsTradeNamePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = rlsTradeNameQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                rlsTradeNamePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->rlsNomensScheduledForDeletion !== null) {
                if (!$this->rlsNomensScheduledForDeletion->isEmpty()) {
                    rlsNomenQuery::create()
                        ->filterByPrimaryKeys($this->rlsNomensScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(rlsTradeNamePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(rlsTradeNamePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(rlsTradeNamePeer::LOCALNAME)) {
            $modifiedColumns[':p' . $index++]  = '`localName`';
        }

        $sql = sprintf(
            'INSERT INTO `rlsTradeName` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = rlsTradeNamePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = rlsTradeNamePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['rlsTradeName'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['rlsTradeName'][$this->getPrimaryKey()] = true;
        $keys = rlsTradeNamePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            $keys[1] => $this->getname(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(rlsTradeNamePeer::ID)) $criteria->add(rlsTradeNamePeer::ID, $this->id);
        if ($this->isColumnModified(rlsTradeNamePeer::NAME)) $criteria->add(rlsTradeNamePeer::NAME, $this->name);
        if ($this->isColumnModified(rlsTradeNamePeer::LOCALNAME)) $criteria->add(rlsTradeNamePeer::LOCALNAME, $this->localname);
    ...
    {
        $criteria = new Criteria(rlsTradeNamePeer::DATABASE_NAME);
        $criteria->add(rlsTradeNamePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of rlsTradeName (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return rlsTradeName Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return rlsTradeNamePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new rlsTradeNamePeer();
        }
     ...
     * If this rlsTradeName is new, it will return
    ...
    public function setrlsNomens(PropelCollection $rlsNomens, PropelPDO $con = null)
    {
        ...
        foreach ($rlsNomensToDelete as $rlsNomenRemoved) {
            $rlsNomenRemoved->setrlsTradeName(null);
        }
    ...
    public function removerlsNomen($rlsNomen)
    {
        if ($this->getrlsNomens()->contains($rlsNomen)) {
            ...
            $this->rlsNomensScheduledForDeletion[]= clone $rlsNomen;
            $rlsNomen->setrlsTradeName(null);
        }
     ...
     * Otherwise if this rlsTradeName is new, it will return
     * an empty collection; or if this rlsTradeName has previously
     * been saved, it will retrieve related rlsNomens from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in rlsTradeName.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|rlsNomen[] List of rlsNomen objects
     */
    public function getrlsNomensJoinrlsPacking($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = rlsNomenQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(rlsTradeNamePeer::DEFAULT_STRING_FORMAT);
    }
