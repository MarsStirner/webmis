...
/**
 * Base class that represents a row from the 'rbTrfuLaboratoryMeasureTypes' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseRbtrfulaboratorymeasuretypes extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbtrfulaboratorymeasuretypesPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RbtrfulaboratorymeasuretypesPeer
     */
     ...
     * @return Rbtrfulaboratorymeasuretypes The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbtrfulaboratorymeasuretypesPeer::ID;
        }
    ...
    public function setTrfuId($v)
    {
        ...
        if ($this->trfu_id !== $v) {
            $this->trfu_id = $v;
            $this->modifiedColumns[] = RbtrfulaboratorymeasuretypesPeer::TRFU_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbtrfulaboratorymeasuretypesPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = RbtrfulaboratorymeasuretypesPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Rbtrfulaboratorymeasuretypes object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbtrfulaboratorymeasuretypesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbtrfulaboratorymeasuretypesQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbtrfulaboratorymeasuretypesPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->trfulaboratorymeasuresScheduledForDeletion !== null) {
                if (!$this->trfulaboratorymeasuresScheduledForDeletion->isEmpty()) {
                    foreach ($this->trfulaboratorymeasuresScheduledForDeletion as $trfulaboratorymeasure) {
                        // need to save related object because we set the relation to null
                        $trfulaboratorymeasure->save($con);
                    }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbtrfulaboratorymeasuretypesPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbtrfulaboratorymeasuretypesPeer::TRFU_ID)) {
            $modifiedColumns[':p' . $index++]  = '`trfu_id`';
        }
        if ($this->isColumnModified(RbtrfulaboratorymeasuretypesPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `rbTrfuLaboratoryMeasureTypes` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbtrfulaboratorymeasuretypesPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbtrfulaboratorymeasuretypesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Rbtrfulaboratorymeasuretypes'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Rbtrfulaboratorymeasuretypes'][$this->getPrimaryKey()] = true;
        $keys = RbtrfulaboratorymeasuretypesPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbtrfulaboratorymeasuretypesPeer::ID)) $criteria->add(RbtrfulaboratorymeasuretypesPeer::ID, $this->id);
        if ($this->isColumnModified(RbtrfulaboratorymeasuretypesPeer::TRFU_ID)) $criteria->add(RbtrfulaboratorymeasuretypesPeer::TRFU_ID, $this->trfu_id);
        if ($this->isColumnModified(RbtrfulaboratorymeasuretypesPeer::NAME)) $criteria->add(RbtrfulaboratorymeasuretypesPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(RbtrfulaboratorymeasuretypesPeer::DATABASE_NAME);
        $criteria->add(RbtrfulaboratorymeasuretypesPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Rbtrfulaboratorymeasuretypes (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Rbtrfulaboratorymeasuretypes Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbtrfulaboratorymeasuretypesPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbtrfulaboratorymeasuretypesPeer();
        }
     ...
     * If this Rbtrfulaboratorymeasuretypes is new, it will return
        ...
        if (null === $this->collTrfulaboratorymeasures || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collTrfulaboratorymeasures) {
                ...
                $collTrfulaboratorymeasures = TrfulaboratorymeasureQuery::create(null, $criteria)
                    ->filterByRbtrfulaboratorymeasuretypes($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setTrfulaboratorymeasures(PropelCollection $trfulaboratorymeasures, PropelPDO $con = null)
    {
        ...
        foreach ($trfulaboratorymeasuresToDelete as $trfulaboratorymeasureRemoved) {
            $trfulaboratorymeasureRemoved->setRbtrfulaboratorymeasuretypes(null);
        }
    ...
    protected function doAddTrfulaboratorymeasure($trfulaboratorymeasure)
    {
        ...
        $trfulaboratorymeasure->setRbtrfulaboratorymeasuretypes($this);
    }
    ...
    public function removeTrfulaboratorymeasure($trfulaboratorymeasure)
    {
        if ($this->getTrfulaboratorymeasures()->contains($trfulaboratorymeasure)) {
            ...
            $this->trfulaboratorymeasuresScheduledForDeletion[]= $trfulaboratorymeasure;
            $trfulaboratorymeasure->setRbtrfulaboratorymeasuretypes(null);
        }
     ...
     * Otherwise if this Rbtrfulaboratorymeasuretypes is new, it will return
     * an empty collection; or if this Rbtrfulaboratorymeasuretypes has previously
     * been saved, it will retrieve related Trfulaboratorymeasures from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Rbtrfulaboratorymeasuretypes.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Trfulaboratorymeasure[] List of Trfulaboratorymeasure objects
     */
    public function getTrfulaboratorymeasuresJoinAction($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TrfulaboratorymeasureQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(RbtrfulaboratorymeasuretypesPeer::DEFAULT_STRING_FORMAT);
    }
