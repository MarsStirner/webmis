...
/**
 * Base class that represents a row from the 'Licence' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseLicence extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\LicencePeer';
    ...
    /**
     * Initializes internal state of BaseLicence object.
     * @see        applyDefaults()
     */
     ...
     * @return Licence The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LicencePeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LicencePeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = LicencePeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LicencePeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = LicencePeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = LicencePeer::DELETED;
        }
    ...
    public function setSerial($v)
    {
        ...
        if ($this->serial !== $v) {
            $this->serial = $v;
            $this->modifiedColumns[] = LicencePeer::SERIAL;
        }
    ...
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[] = LicencePeer::NUMBER;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LicencePeer::DATE;
            }
        } // if either are not null
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = LicencePeer::PERSON_ID;
        }
    ...
    public function setBegdate($v)
    {
        ...
        if ($this->begdate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LicencePeer::BEGDATE;
            }
        } // if either are not null
    ...
    public function setEnddate($v)
    {
        ...
        if ($this->enddate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LicencePeer::ENDDATE;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->serial = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->number = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->date = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->person_id = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
            ...
            return $startcol + 12; // 12 = LicencePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Licence object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LicencePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LicenceQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LicencePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LicencePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LicencePeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(LicencePeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(LicencePeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(LicencePeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(LicencePeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(LicencePeer::SERIAL)) {
            $modifiedColumns[':p' . $index++]  = '`serial`';
        }
        if ($this->isColumnModified(LicencePeer::NUMBER)) {
            $modifiedColumns[':p' . $index++]  = '`number`';
        }
        if ($this->isColumnModified(LicencePeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }
        if ($this->isColumnModified(LicencePeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`person_id`';
        }
        if ($this->isColumnModified(LicencePeer::BEGDATE)) {
            $modifiedColumns[':p' . $index++]  = '`begDate`';
        }
        if ($this->isColumnModified(LicencePeer::ENDDATE)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LicencePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LicencePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $keys = LicencePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setSerial($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setNumber($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setDate($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setPersonId($arr[$keys[9]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LicencePeer::ID)) $criteria->add(LicencePeer::ID, $this->id);
        if ($this->isColumnModified(LicencePeer::CREATEDATETIME)) $criteria->add(LicencePeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(LicencePeer::CREATEPERSON_ID)) $criteria->add(LicencePeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(LicencePeer::MODIFYDATETIME)) $criteria->add(LicencePeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(LicencePeer::MODIFYPERSON_ID)) $criteria->add(LicencePeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(LicencePeer::DELETED)) $criteria->add(LicencePeer::DELETED, $this->deleted);
        if ($this->isColumnModified(LicencePeer::SERIAL)) $criteria->add(LicencePeer::SERIAL, $this->serial);
        if ($this->isColumnModified(LicencePeer::NUMBER)) $criteria->add(LicencePeer::NUMBER, $this->number);
        if ($this->isColumnModified(LicencePeer::DATE)) $criteria->add(LicencePeer::DATE, $this->date);
        if ($this->isColumnModified(LicencePeer::PERSON_ID)) $criteria->add(LicencePeer::PERSON_ID, $this->person_id);
        if ($this->isColumnModified(LicencePeer::BEGDATE)) $criteria->add(LicencePeer::BEGDATE, $this->begdate);
        if ($this->isColumnModified(LicencePeer::ENDDATE)) $criteria->add(LicencePeer::ENDDATE, $this->enddate);
    ...
    {
        $criteria = new Criteria(LicencePeer::DATABASE_NAME);
        $criteria->add(LicencePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Licence (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Licence Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(LicencePeer::DEFAULT_STRING_FORMAT);
    }
