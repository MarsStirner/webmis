...
/**
 * Base class that represents a row from the 'rlsActMatters' table.
 *
 *
 *
 * @package    propel.generator.Models.om
 */
abstract class BaserlsActMatters extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\rlsActMattersPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        rlsActMattersPeer
     */
     ...
     * @return rlsActMatters The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = rlsActMattersPeer::ID;
        }
    ...
    public function setname($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = rlsActMattersPeer::NAME;
        }
    ...
    public function setlocalName($v)
    {
        ...
        if ($this->localname !== $v) {
            $this->localname = $v;
            $this->modifiedColumns[] = rlsActMattersPeer::LOCALNAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = rlsActMattersPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating rlsActMatters object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = rlsActMattersPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = rlsActMattersQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                rlsActMattersPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(rlsActMattersPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(rlsActMattersPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(rlsActMattersPeer::LOCALNAME)) {
            $modifiedColumns[':p' . $index++]  = '`localName`';
        }

        $sql = sprintf(
            'INSERT INTO `rlsActMatters` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = rlsActMattersPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = rlsActMattersPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['rlsActMatters'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['rlsActMatters'][$this->getPrimaryKey()] = true;
        $keys = rlsActMattersPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            $keys[1] => $this->getname(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(rlsActMattersPeer::ID)) $criteria->add(rlsActMattersPeer::ID, $this->id);
        if ($this->isColumnModified(rlsActMattersPeer::NAME)) $criteria->add(rlsActMattersPeer::NAME, $this->name);
        if ($this->isColumnModified(rlsActMattersPeer::LOCALNAME)) $criteria->add(rlsActMattersPeer::LOCALNAME, $this->localname);
    ...
    {
        $criteria = new Criteria(rlsActMattersPeer::DATABASE_NAME);
        $criteria->add(rlsActMattersPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of rlsActMatters (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return rlsActMatters Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return rlsActMattersPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new rlsActMattersPeer();
        }
     ...
     * If this rlsActMatters is new, it will return
    ...
    public function setrlsNomens(PropelCollection $rlsNomens, PropelPDO $con = null)
    {
        ...
        foreach ($rlsNomensToDelete as $rlsNomenRemoved) {
            $rlsNomenRemoved->setrlsActMatters(null);
        }
    ...
    protected function doAddrlsNomen($rlsNomen)
    {
        ...
        $rlsNomen->setrlsActMatters($this);
    }
    ...
    public function removerlsNomen($rlsNomen)
    {
        if ($this->getrlsNomens()->contains($rlsNomen)) {
            ...
            $rlsNomen->setrlsActMatters(null);
        }
     ...
     * Otherwise if this rlsActMatters is new, it will return
     * an empty collection; or if this rlsActMatters has previously
     * been saved, it will retrieve related rlsNomens from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in rlsActMatters.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(rlsActMattersPeer::DEFAULT_STRING_FORMAT);
    }
