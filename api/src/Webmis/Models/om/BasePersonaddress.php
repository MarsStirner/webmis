...
/**
 * Base class that represents a row from the 'PersonAddress' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BasePersonaddress extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\PersonaddressPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PersonaddressPeer
     */
     ...
     * @return Personaddress The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PersonaddressPeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PersonaddressPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = PersonaddressPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PersonaddressPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = PersonaddressPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = PersonaddressPeer::DELETED;
        }
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = PersonaddressPeer::PERSON_ID;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = PersonaddressPeer::TYPE;
        }
    ...
    public function setAddressId($v)
    {
        ...
        if ($this->address_id !== $v) {
            $this->address_id = $v;
            $this->modifiedColumns[] = PersonaddressPeer::ADDRESS_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 9; // 9 = PersonaddressPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Personaddress object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PersonaddressPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PersonaddressQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PersonaddressPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PersonaddressPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PersonaddressPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(PersonaddressPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(PersonaddressPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(PersonaddressPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(PersonaddressPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(PersonaddressPeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`person_id`';
        }
        if ($this->isColumnModified(PersonaddressPeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(PersonaddressPeer::ADDRESS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`address_id`';
        }

        $sql = sprintf(
            'INSERT INTO `PersonAddress` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PersonaddressPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PersonaddressPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Personaddress'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Personaddress'][$this->getPrimaryKey()] = true;
        $keys = PersonaddressPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PersonaddressPeer::ID)) $criteria->add(PersonaddressPeer::ID, $this->id);
        if ($this->isColumnModified(PersonaddressPeer::CREATEDATETIME)) $criteria->add(PersonaddressPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(PersonaddressPeer::CREATEPERSON_ID)) $criteria->add(PersonaddressPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(PersonaddressPeer::MODIFYDATETIME)) $criteria->add(PersonaddressPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(PersonaddressPeer::MODIFYPERSON_ID)) $criteria->add(PersonaddressPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(PersonaddressPeer::DELETED)) $criteria->add(PersonaddressPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(PersonaddressPeer::PERSON_ID)) $criteria->add(PersonaddressPeer::PERSON_ID, $this->person_id);
        if ($this->isColumnModified(PersonaddressPeer::TYPE)) $criteria->add(PersonaddressPeer::TYPE, $this->type);
        if ($this->isColumnModified(PersonaddressPeer::ADDRESS_ID)) $criteria->add(PersonaddressPeer::ADDRESS_ID, $this->address_id);
    ...
    {
        $criteria = new Criteria(PersonaddressPeer::DATABASE_NAME);
        $criteria->add(PersonaddressPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Personaddress (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Personaddress Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PersonaddressPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PersonaddressPeer();
        }
    ...
    {
        return (string) $this->exportTo(PersonaddressPeer::DEFAULT_STRING_FORMAT);
    }
