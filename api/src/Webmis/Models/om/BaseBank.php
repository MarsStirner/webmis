...
abstract class BaseBank extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\BankPeer';
    ...
    /**
     * The value for the corraccount field.
     * @var        string
     */
    protected $corraccount;

    /**
     * The value for the subaccount field.
     * @var        string
     */
    ...
    /**
     * Get the [corraccount] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [subaccount] column value.
     *
     * @return string
     */
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BankPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = BankPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BankPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = BankPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = BankPeer::DELETED;
        }
    ...
    /**
     * Set the value of [bik] column.
     *
     * @param string $v new value
     * @return Bank The current object (for fluent API support)
     */
    public function setBik($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->bik !== $v) {
            $this->bik = $v;
            $this->modifiedColumns[] = BankPeer::BIK;
        }
    ...
    public function setBranchname($v)
    {
        ...
        if ($this->branchname !== $v) {
            $this->branchname = $v;
            $this->modifiedColumns[] = BankPeer::BRANCHNAME;
        }
    ...
    /**
     * Set the value of [corraccount] column.
     *
     * @param string $v new value
     * @return Bank The current object (for fluent API support)
     */
    public function setCorraccount($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->corraccount !== $v) {
            $this->corraccount = $v;
            $this->modifiedColumns[] = BankPeer::CORRACCOUNT;
        }
    ...
    /**
     * Set the value of [subaccount] column.
     *
     * @param string $v new value
     * @return Bank The current object (for fluent API support)
     */
    public function setSubaccount($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->subaccount !== $v) {
            $this->subaccount = $v;
            $this->modifiedColumns[] = BankPeer::SUBACCOUNT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->bik = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->name = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->branchname = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->corraccount = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->subaccount = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->resetModified();
            ...
            return $startcol + 11; // 11 = BankPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BankPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(BankPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(BankPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(BankPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(BankPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(BankPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(BankPeer::BIK)) {
            $modifiedColumns[':p' . $index++]  = '`BIK`';
        }
        if ($this->isColumnModified(BankPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(BankPeer::BRANCHNAME)) {
            $modifiedColumns[':p' . $index++]  = '`branchName`';
        }
        if ($this->isColumnModified(BankPeer::CORRACCOUNT)) {
            $modifiedColumns[':p' . $index++]  = '`corrAccount`';
        }
        if ($this->isColumnModified(BankPeer::SUBACCOUNT)) {
            $modifiedColumns[':p' . $index++]  = '`subAccount`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`deleted`':
                        ...
                        break;
                    case '`BIK`':
                        $stmt->bindValue($identifier, $this->bik, PDO::PARAM_STR);
                        break;
                    case '`name`':
                    ...
                    case '`branchName`':
                        ...
                        break;
                    case '`corrAccount`':
                        $stmt->bindValue($identifier, $this->corraccount, PDO::PARAM_STR);
                        break;
                    case '`subAccount`':
                        $stmt->bindValue($identifier, $this->subaccount, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 8:
                ...
                break;
            case 9:
                return $this->getCorraccount();
                break;
            case 10:
                return $this->getSubaccount();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getBik(),
            $keys[7] => $this->getName(),
            $keys[8] => $this->getBranchname(),
            $keys[9] => $this->getCorraccount(),
            $keys[10] => $this->getSubaccount(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 8:
                ...
                break;
            case 9:
                $this->setCorraccount($value);
                break;
            case 10:
                $this->setSubaccount($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setBik($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setName($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setBranchname($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setCorraccount($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setSubaccount($arr[$keys[10]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BankPeer::CREATEDATETIME)) $criteria->add(BankPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(BankPeer::CREATEPERSON_ID)) $criteria->add(BankPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(BankPeer::MODIFYDATETIME)) $criteria->add(BankPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(BankPeer::MODIFYPERSON_ID)) $criteria->add(BankPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(BankPeer::DELETED)) $criteria->add(BankPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(BankPeer::BIK)) $criteria->add(BankPeer::BIK, $this->bik);
        if ($this->isColumnModified(BankPeer::NAME)) $criteria->add(BankPeer::NAME, $this->name);
        if ($this->isColumnModified(BankPeer::BRANCHNAME)) $criteria->add(BankPeer::BRANCHNAME, $this->branchname);
        if ($this->isColumnModified(BankPeer::CORRACCOUNT)) $criteria->add(BankPeer::CORRACCOUNT, $this->corraccount);
        if ($this->isColumnModified(BankPeer::SUBACCOUNT)) $criteria->add(BankPeer::SUBACCOUNT, $this->subaccount);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setBik($this->getBik());
        $copyObj->setName($this->getName());
        $copyObj->setBranchname($this->getBranchname());
        $copyObj->setCorraccount($this->getCorraccount());
        $copyObj->setSubaccount($this->getSubaccount());
        if ($makeNew) {
            $copyObj->setNew(true);
