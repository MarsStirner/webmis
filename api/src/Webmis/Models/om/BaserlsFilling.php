...
abstract class BaserlsFilling extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = rlsFillingPeer::NUM_HYDRATE_COLUMNS.
     ...
     * If this rlsFilling is new, it will return
    ...
    public function setrlsNomens(PropelCollection $rlsNomens, PropelPDO $con = null)
    {
        ...
        foreach ($rlsNomensToDelete as $rlsNomenRemoved) {
            $rlsNomenRemoved->setrlsFilling(null);
        }
     ...
     * Otherwise if this rlsFilling is new, it will return
     * an empty collection; or if this rlsFilling has previously
     * been saved, it will retrieve related rlsNomens from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in rlsFilling.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
