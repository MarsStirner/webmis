...
abstract class BaseActionPeer
{
    ...
    /**
     * Returns the number of rows matching criteria, joining the related Takentissuejournal table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinTakentissuejournal(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ActionPeer::TAKENTISSUEJOURNAL_ID, TakentissuejournalPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Action objects pre-filled with their Takentissuejournal objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinTakentissuejournal(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = TakentissuejournalPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = TakentissuejournalPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    TakentissuejournalPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Action) to $obj2 (Takentissuejournal)
                $obj2->addAction($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        TakentissuejournalPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + TakentissuejournalPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined Takentissuejournal rows

            $key2 = TakentissuejournalPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = TakentissuejournalPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (Action) to the collection in $obj2 (Takentissuejournal)
                $obj2->addAction($obj1);
