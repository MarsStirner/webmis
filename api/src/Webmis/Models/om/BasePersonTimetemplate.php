...
/**
 * Base class that represents a row from the 'Person_TimeTemplate' table.
 *
 *
 *
...
abstract class BasePersonTimetemplate extends BaseObject implements Persistent
{
     ...
     * @var        Person
     */
    protected $aPersonRelatedByMasterId;
    ...
    public function setMasterId($v)
    {
        ...
        if ($this->aPersonRelatedByMasterId !== null && $this->aPersonRelatedByMasterId->getId() !== $v) {
            $this->aPersonRelatedByMasterId = null;
        }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aPersonRelatedByMasterId !== null && $this->master_id !== $this->aPersonRelatedByMasterId->getId()) {
            $this->aPersonRelatedByMasterId = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aPersonRelatedByMasterId !== null) {
                if ($this->aPersonRelatedByMasterId->isModified() || $this->aPersonRelatedByMasterId->isNew()) {
                    $affectedRows += $this->aPersonRelatedByMasterId->save($con);
                }
                $this->setPersonRelatedByMasterId($this->aPersonRelatedByMasterId);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `Person_TimeTemplate` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aPersonRelatedByMasterId !== null) {
                if (!$this->aPersonRelatedByMasterId->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aPersonRelatedByMasterId->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aPersonRelatedByMasterId) {
                $result['PersonRelatedByMasterId'] = $this->aPersonRelatedByMasterId->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function setPersonRelatedByCreatepersonId(Person $v = null)
    {
        ...
        if ($v !== null) {
            $v->addPersonTimetemplateRelatedByCreatepersonId($this);
        }
    ...
    public function getPersonRelatedByCreatepersonId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPersonRelatedByCreatepersonId === null && ($this->createperson_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPersonRelatedByCreatepersonId->addPersonTimetemplatesRelatedByCreatepersonId($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setPersonRelatedByMasterId(Person $v = null)
    {
        if ($v === null) {
        ...
        $this->aPersonRelatedByMasterId = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the Person object, it will not be re-added.
        if ($v !== null) {
            $v->addPersonTimetemplateRelatedByMasterId($this);
        }
     ...
     * @throws PropelException
     */
    public function getPersonRelatedByMasterId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPersonRelatedByMasterId === null && ($this->master_id !== null) && $doQuery) {
            $this->aPersonRelatedByMasterId = PersonQuery::create()->findPk($this->master_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPersonRelatedByMasterId->addPersonTimetemplatesRelatedByMasterId($this);
             */
        }

        return $this->aPersonRelatedByMasterId;
    }
    ...
    public function setPersonRelatedByModifypersonId(Person $v = null)
    {
        ...
        // If this object has already been added to the Person object, it will not be re-added.
        if ($v !== null) {
            $v->addPersonTimetemplateRelatedByModifypersonId($this);
        }
    ...
    public function getPersonRelatedByModifypersonId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPersonRelatedByModifypersonId === null && ($this->modifyperson_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPersonRelatedByModifypersonId->addPersonTimetemplatesRelatedByModifypersonId($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aPersonRelatedByMasterId instanceof Persistent) {
              $this->aPersonRelatedByMasterId->clearAllReferences($deep);
            }
