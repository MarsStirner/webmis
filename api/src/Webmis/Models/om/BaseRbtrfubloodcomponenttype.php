...
/**
 * Base class that represents a row from the 'rbTrfuBloodComponentType' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseRbtrfubloodcomponenttype extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbtrfubloodcomponenttypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RbtrfubloodcomponenttypePeer
     */
    ...
    /**
     * The value for the trfu_id field.
     * @var        int
     */
    protected $trfu_id;
    ...
    /**
     * Initializes internal state of BaseRbtrfubloodcomponenttype object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [trfu_id] column value.
     *
     * @return int
     */
    public function getTrfuId()
    {
        return $this->trfu_id;
    }
     ...
     * @return Rbtrfubloodcomponenttype The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbtrfubloodcomponenttypePeer::ID;
        }
    ...
    /**
     * Set the value of [trfu_id] column.
     *
     * @param int $v new value
     * @return Rbtrfubloodcomponenttype The current object (for fluent API support)
     */
    public function setTrfuId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }
        ...
        if ($this->trfu_id !== $v) {
            $this->trfu_id = $v;
            $this->modifiedColumns[] = RbtrfubloodcomponenttypePeer::TRFU_ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = RbtrfubloodcomponenttypePeer::CODE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbtrfubloodcomponenttypePeer::NAME;
        }
    ...
    /**
     * Sets the value of the [unused] column.
    ...
    public function setUnused($v)
    {
        ...
        if ($this->unused !== $v) {
            $this->unused = $v;
            $this->modifiedColumns[] = RbtrfubloodcomponenttypePeer::UNUSED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->trfu_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->code = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->name = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->unused = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = RbtrfubloodcomponenttypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Rbtrfubloodcomponenttype object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbtrfubloodcomponenttypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbtrfubloodcomponenttypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbtrfubloodcomponenttypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->trfuorderissueresultsScheduledForDeletion !== null) {
                if (!$this->trfuorderissueresultsScheduledForDeletion->isEmpty()) {
                    foreach ($this->trfuorderissueresultsScheduledForDeletion as $trfuorderissueresult) {
                        // need to save related object because we set the relation to null
                        $trfuorderissueresult->save($con);
                    }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbtrfubloodcomponenttypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbtrfubloodcomponenttypePeer::TRFU_ID)) {
            $modifiedColumns[':p' . $index++]  = '`trfu_id`';
        }
        if ($this->isColumnModified(RbtrfubloodcomponenttypePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(RbtrfubloodcomponenttypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(RbtrfubloodcomponenttypePeer::UNUSED)) {
            $modifiedColumns[':p' . $index++]  = '`unused`';
        }

        $sql = sprintf(
            'INSERT INTO `rbTrfuBloodComponentType` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`trfu_id`':
                        $stmt->bindValue($identifier, $this->trfu_id, PDO::PARAM_INT);
                        break;
                    case '`code`':
                    ...
                    case '`name`':
                        ...
                        break;
                    case '`unused`':
                        $stmt->bindValue($identifier, (int) $this->unused, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbtrfubloodcomponenttypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbtrfubloodcomponenttypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Rbtrfubloodcomponenttype'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Rbtrfubloodcomponenttype'][$this->getPrimaryKey()] = true;
        $keys = RbtrfubloodcomponenttypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getTrfuId(),
            $keys[2] => $this->getCode(),
            $keys[3] => $this->getName(),
            $keys[4] => $this->getUnused(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setTrfuId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setCode($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setName($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setUnused($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbtrfubloodcomponenttypePeer::ID)) $criteria->add(RbtrfubloodcomponenttypePeer::ID, $this->id);
        if ($this->isColumnModified(RbtrfubloodcomponenttypePeer::TRFU_ID)) $criteria->add(RbtrfubloodcomponenttypePeer::TRFU_ID, $this->trfu_id);
        if ($this->isColumnModified(RbtrfubloodcomponenttypePeer::CODE)) $criteria->add(RbtrfubloodcomponenttypePeer::CODE, $this->code);
        if ($this->isColumnModified(RbtrfubloodcomponenttypePeer::NAME)) $criteria->add(RbtrfubloodcomponenttypePeer::NAME, $this->name);
        if ($this->isColumnModified(RbtrfubloodcomponenttypePeer::UNUSED)) $criteria->add(RbtrfubloodcomponenttypePeer::UNUSED, $this->unused);
    ...
    {
        $criteria = new Criteria(RbtrfubloodcomponenttypePeer::DATABASE_NAME);
        $criteria->add(RbtrfubloodcomponenttypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Rbtrfubloodcomponenttype (or compatible) type.
    ...
    {
        $copyObj->setTrfuId($this->getTrfuId());
        $copyObj->setCode($this->getCode());
        $copyObj->setName($this->getName());
        $copyObj->setUnused($this->getUnused());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Rbtrfubloodcomponenttype Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbtrfubloodcomponenttypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbtrfubloodcomponenttypePeer();
        }
     ...
     * If this Rbtrfubloodcomponenttype is new, it will return
        ...
        if (null === $this->collTrfuorderissueresults || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collTrfuorderissueresults) {
                ...
                $collTrfuorderissueresults = TrfuorderissueresultQuery::create(null, $criteria)
                    ->filterByRbtrfubloodcomponenttype($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setTrfuorderissueresults(PropelCollection $trfuorderissueresults, PropelPDO $con = null)
    {
        ...
        foreach ($trfuorderissueresultsToDelete as $trfuorderissueresultRemoved) {
            $trfuorderissueresultRemoved->setRbtrfubloodcomponenttype(null);
        }
    ...
    protected function doAddTrfuorderissueresult($trfuorderissueresult)
    {
        ...
        $trfuorderissueresult->setRbtrfubloodcomponenttype($this);
    }
    ...
    public function removeTrfuorderissueresult($trfuorderissueresult)
    {
        if ($this->getTrfuorderissueresults()->contains($trfuorderissueresult)) {
            ...
            $this->trfuorderissueresultsScheduledForDeletion[]= $trfuorderissueresult;
            $trfuorderissueresult->setRbtrfubloodcomponenttype(null);
        }
     ...
     * Otherwise if this Rbtrfubloodcomponenttype is new, it will return
     * an empty collection; or if this Rbtrfubloodcomponenttype has previously
     * been saved, it will retrieve related Trfuorderissueresults from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Rbtrfubloodcomponenttype.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Trfuorderissueresult[] List of Trfuorderissueresult objects
     */
    public function getTrfuorderissueresultsJoinAction($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TrfuorderissueresultQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(RbtrfubloodcomponenttypePeer::DEFAULT_STRING_FORMAT);
    }
