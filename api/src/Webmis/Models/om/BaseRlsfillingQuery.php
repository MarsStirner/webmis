 ...
 * @method RlsfillingQuery orderByDisabledforprescription($order = Criteria::ASC) Order by the disabledForPrescription column
 *
 * @method RlsfillingQuery groupById() Group by the id column
 * @method RlsfillingQuery groupByName() Group by the name column
 * @method RlsfillingQuery groupByDisabledforprescription() Group by the disabledForPrescription column
 *
 ...
 * @method Rlsfilling findOneByDisabledforprescription(boolean $disabledForPrescription) Return the first Rlsfilling filtered by the disabledForPrescription column
 *
 ...
 * @method array findByDisabledforprescription(boolean $disabledForPrescription) Return Rlsfilling objects filtered by the disabledForPrescription column
 *
...
abstract class BaseRlsfillingQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `name`, `disabledForPrescription` FROM `rlsFilling` WHERE `id` = :p0';
        try {
    ...
    public function filterByDisabledforprescription($disabledforprescription = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(RlsfillingPeer::DISABLEDFORPRESCRIPTION, $disabledforprescription, $comparison);
    }
