...
/**
 * Base class that represents a row from the 'rbStorage' table.
 *
 *
 *
 * @package    propel.generator.Models.om
 */
abstract class BaseRbStorage extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\RbStoragePeer';
     ...
     * @return RbStorage The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RbStoragePeer::ID;
        }
    ...
    public function setuuid($v)
    {
        ...
        if ($this->uuid !== $v) {
            $this->uuid = $v;
            $this->modifiedColumns[] = RbStoragePeer::UUID;
        }
    ...
    public function setname($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RbStoragePeer::NAME;
        }
    ...
    public function setorgStructureId($v)
    {
        ...
        if ($this->orgstructure_id !== $v) {
            ...
            $this->modifiedColumns[] = RbStoragePeer::ORGSTRUCTURE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->orgstructure_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = RbStoragePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RbStorage object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RbStoragePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RbStorageQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RbStoragePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->rlsBalanceOfGoodssScheduledForDeletion !== null) {
                if (!$this->rlsBalanceOfGoodssScheduledForDeletion->isEmpty()) {
                    foreach ($this->rlsBalanceOfGoodssScheduledForDeletion as $rlsBalanceOfGoods) {
                        // need to save related object because we set the relation to null
                        $rlsBalanceOfGoods->save($con);
                    }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RbStoragePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RbStoragePeer::UUID)) {
            $modifiedColumns[':p' . $index++]  = '`uuid`';
        }
        if ($this->isColumnModified(RbStoragePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(RbStoragePeer::ORGSTRUCTURE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`orgStructure_id`';
        }

        $sql = sprintf(
            'INSERT INTO `rbStorage` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RbStoragePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RbStoragePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['RbStorage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RbStorage'][$this->getPrimaryKey()] = true;
        $keys = RbStoragePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            $keys[1] => $this->getuuid(),
            $keys[2] => $this->getname(),
            $keys[3] => $this->getorgStructureId(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setorgStructureId($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RbStoragePeer::ID)) $criteria->add(RbStoragePeer::ID, $this->id);
        if ($this->isColumnModified(RbStoragePeer::UUID)) $criteria->add(RbStoragePeer::UUID, $this->uuid);
        if ($this->isColumnModified(RbStoragePeer::NAME)) $criteria->add(RbStoragePeer::NAME, $this->name);
        if ($this->isColumnModified(RbStoragePeer::ORGSTRUCTURE_ID)) $criteria->add(RbStoragePeer::ORGSTRUCTURE_ID, $this->orgstructure_id);
    ...
    {
        $criteria = new Criteria(RbStoragePeer::DATABASE_NAME);
        $criteria->add(RbStoragePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of RbStorage (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RbStorage Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RbStoragePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RbStoragePeer();
        }
    ...
    public function getOrgStructure(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOrgStructure === null && ($this->orgstructure_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aOrgStructure->addRbStorages($this);
             */
        }
     ...
     * If this RbStorage is new, it will return
    ...
    public function setRlsBalanceOfGoodss(PropelCollection $rlsBalanceOfGoodss, PropelPDO $con = null)
    {
        ...
        foreach ($rlsBalanceOfGoodssToDelete as $rlsBalanceOfGoodsRemoved) {
            $rlsBalanceOfGoodsRemoved->setRbStorage(null);
        }
    ...
    protected function doAddRlsBalanceOfGoods($rlsBalanceOfGoods)
    {
        ...
        $rlsBalanceOfGoods->setRbStorage($this);
    }
    ...
    public function removeRlsBalanceOfGoods($rlsBalanceOfGoods)
    {
        if ($this->getRlsBalanceOfGoodss()->contains($rlsBalanceOfGoods)) {
            ...
            $this->rlsBalanceOfGoodssScheduledForDeletion[]= $rlsBalanceOfGoods;
            $rlsBalanceOfGoods->setRbStorage(null);
        }
     ...
     * Otherwise if this RbStorage is new, it will return
     * an empty collection; or if this RbStorage has previously
     * been saved, it will retrieve related RlsBalanceOfGoodss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in RbStorage.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|RlsBalanceOfGoods[] List of RlsBalanceOfGoods objects
     */
    public function getRlsBalanceOfGoodssJoinrlsNomen($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = RlsBalanceOfGoodsQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(RbStoragePeer::DEFAULT_STRING_FORMAT);
    }
