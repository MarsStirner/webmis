...
/**
 * Base class that represents a row from the 'ClientPolicy' table.
 *
 *
 *
 * @package    propel.generator.Webmis.Models.om
 */
abstract class BaseClientpolicy extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Webmis\\Models\\ClientpolicyPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ClientpolicyPeer
     */
    ...
    /**
     * Initializes internal state of BaseClientpolicy object.
     * @see        applyDefaults()
     */
     ...
     * @return Clientpolicy The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ClientpolicyPeer::ID;
        }
    ...
    public function setCreatedatetime($v)
    {
        ...
        if ($this->createdatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientpolicyPeer::CREATEDATETIME;
            }
    ...
    public function setCreatepersonId($v)
    {
        ...
        if ($this->createperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientpolicyPeer::CREATEPERSON_ID;
        }
    ...
    public function setModifydatetime($v)
    {
        ...
        if ($this->modifydatetime !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientpolicyPeer::MODIFYDATETIME;
            }
        } // if either are not null
    ...
    public function setModifypersonId($v)
    {
        ...
        if ($this->modifyperson_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientpolicyPeer::MODIFYPERSON_ID;
        }
    ...
    public function setDeleted($v)
    {
        ...
        if ($this->deleted !== $v) {
            $this->deleted = $v;
            $this->modifiedColumns[] = ClientpolicyPeer::DELETED;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = ClientpolicyPeer::CLIENT_ID;
        }
    ...
    public function setInsurerId($v)
    {
        ...
        if ($this->insurer_id !== $v) {
            $this->insurer_id = $v;
            $this->modifiedColumns[] = ClientpolicyPeer::INSURER_ID;
        }
    ...
    public function setPolicytypeId($v)
    {
        ...
        if ($this->policytype_id !== $v) {
            ...
            $this->modifiedColumns[] = ClientpolicyPeer::POLICYTYPE_ID;
        }
    ...
    public function setSerial($v)
    {
        ...
        if ($this->serial !== $v) {
            $this->serial = $v;
            $this->modifiedColumns[] = ClientpolicyPeer::SERIAL;
        }
    ...
    public function setNumber($v)
    {
        ...
        if ($this->number !== $v) {
            $this->number = $v;
            $this->modifiedColumns[] = ClientpolicyPeer::NUMBER;
        }
    ...
    public function setBegdate($v)
    {
        ...
        if ($this->begdate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientpolicyPeer::BEGDATE;
            }
        } // if either are not null
    ...
    public function setEnddate($v)
    {
        ...
        if ($this->enddate !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ClientpolicyPeer::ENDDATE;
            }
        } // if either are not null
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = ClientpolicyPeer::NAME;
        }
    ...
    public function setNote($v)
    {
        ...
        if ($this->note !== $v) {
            $this->note = $v;
            $this->modifiedColumns[] = ClientpolicyPeer::NOTE;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = ClientpolicyPeer::VERSION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->begdate = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->enddate = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            ...
            return $startcol + 16; // 16 = ClientpolicyPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Clientpolicy object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ClientpolicyPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ClientpolicyQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ClientpolicyPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClientpolicyPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::CREATEDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`createDatetime`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::CREATEPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`createPerson_id`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::MODIFYDATETIME)) {
            $modifiedColumns[':p' . $index++]  = '`modifyDatetime`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::MODIFYPERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`modifyPerson_id`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::DELETED)) {
            $modifiedColumns[':p' . $index++]  = '`deleted`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::INSURER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`insurer_id`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::POLICYTYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`policyType_id`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::SERIAL)) {
            $modifiedColumns[':p' . $index++]  = '`serial`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::NUMBER)) {
            $modifiedColumns[':p' . $index++]  = '`number`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::BEGDATE)) {
            $modifiedColumns[':p' . $index++]  = '`begDate`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::ENDDATE)) {
            $modifiedColumns[':p' . $index++]  = '`endDate`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::NOTE)) {
            $modifiedColumns[':p' . $index++]  = '`note`';
        }
        if ($this->isColumnModified(ClientpolicyPeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`version`';
        }

        $sql = sprintf(
            'INSERT INTO `ClientPolicy` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ClientpolicyPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ClientpolicyPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Clientpolicy'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Clientpolicy'][$this->getPrimaryKey()] = true;
        $keys = ClientpolicyPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[11], $arr)) $this->setBegdate($arr[$keys[11]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientpolicyPeer::ID)) $criteria->add(ClientpolicyPeer::ID, $this->id);
        if ($this->isColumnModified(ClientpolicyPeer::CREATEDATETIME)) $criteria->add(ClientpolicyPeer::CREATEDATETIME, $this->createdatetime);
        if ($this->isColumnModified(ClientpolicyPeer::CREATEPERSON_ID)) $criteria->add(ClientpolicyPeer::CREATEPERSON_ID, $this->createperson_id);
        if ($this->isColumnModified(ClientpolicyPeer::MODIFYDATETIME)) $criteria->add(ClientpolicyPeer::MODIFYDATETIME, $this->modifydatetime);
        if ($this->isColumnModified(ClientpolicyPeer::MODIFYPERSON_ID)) $criteria->add(ClientpolicyPeer::MODIFYPERSON_ID, $this->modifyperson_id);
        if ($this->isColumnModified(ClientpolicyPeer::DELETED)) $criteria->add(ClientpolicyPeer::DELETED, $this->deleted);
        if ($this->isColumnModified(ClientpolicyPeer::CLIENT_ID)) $criteria->add(ClientpolicyPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(ClientpolicyPeer::INSURER_ID)) $criteria->add(ClientpolicyPeer::INSURER_ID, $this->insurer_id);
        if ($this->isColumnModified(ClientpolicyPeer::POLICYTYPE_ID)) $criteria->add(ClientpolicyPeer::POLICYTYPE_ID, $this->policytype_id);
        if ($this->isColumnModified(ClientpolicyPeer::SERIAL)) $criteria->add(ClientpolicyPeer::SERIAL, $this->serial);
        if ($this->isColumnModified(ClientpolicyPeer::NUMBER)) $criteria->add(ClientpolicyPeer::NUMBER, $this->number);
        if ($this->isColumnModified(ClientpolicyPeer::BEGDATE)) $criteria->add(ClientpolicyPeer::BEGDATE, $this->begdate);
        if ($this->isColumnModified(ClientpolicyPeer::ENDDATE)) $criteria->add(ClientpolicyPeer::ENDDATE, $this->enddate);
        if ($this->isColumnModified(ClientpolicyPeer::NAME)) $criteria->add(ClientpolicyPeer::NAME, $this->name);
        if ($this->isColumnModified(ClientpolicyPeer::NOTE)) $criteria->add(ClientpolicyPeer::NOTE, $this->note);
        if ($this->isColumnModified(ClientpolicyPeer::VERSION)) $criteria->add(ClientpolicyPeer::VERSION, $this->version);
    ...
    {
        $criteria = new Criteria(ClientpolicyPeer::DATABASE_NAME);
        $criteria->add(ClientpolicyPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Clientpolicy (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Clientpolicy Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ClientpolicyPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ClientpolicyPeer();
        }
    ...
    {
        return (string) $this->exportTo(ClientpolicyPeer::DEFAULT_STRING_FORMAT);
    }
