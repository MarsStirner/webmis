 ...
 * @method ActionpropertyTimeQuery orderByValue($order = Criteria::ASC) Order by the value column
 *
 ...
 * @method ActionpropertyTimeQuery groupByValue() Group by the value column
 *
 ...
 * @method ActionpropertyTime findOneByValue(string $value) Return the first ActionpropertyTime filtered by the value column
 *
 ...
 * @method array findByValue(string $value) Return ActionpropertyTime objects filtered by the value column
 *
...
abstract class BaseActionpropertyTimeQuery extends ModelCriteria
{
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        if (is_array($value)) {
            $useMinMax = false;
            if (isset($value['min'])) {
                $this->addUsingAlias(ActionpropertyTimePeer::VALUE, $value['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($value['max'])) {
                $this->addUsingAlias(ActionpropertyTimePeer::VALUE, $value['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ActionpropertyTimePeer::VALUE, $value, $comparison);
    }
