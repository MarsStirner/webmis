...
/**
 * This class defines the structure of the 'ClientContact' table.
 *
 *
 *
...
class ClientcontactTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Webmis.Models.map.ClientcontactTableMap';
    ...
    {
        // attributes
        $this->setName('ClientContact');
        $this->setPhpName('Clientcontact');
        $this->setClassname('Webmis\\Models\\Clientcontact');
        ...
        $this->addColumn('contactType_id', 'ContacttypeId', 'INTEGER', true, null, null);
        $this->addColumn('contact', 'Contact', 'VARCHAR', true, 32, null);
        $this->addColumn('notes', 'Notes', 'VARCHAR', true, 64, null);
