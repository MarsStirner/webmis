...
/**
 * This class defines the structure of the 'ClientIntoleranceMedicament' table.
 *
 *
 *
 ...
 */
class ClientintolerancemedicamentTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Webmis.Models.map.ClientintolerancemedicamentTableMap';
    ...
    {
        // attributes
        $this->setName('ClientIntoleranceMedicament');
        $this->setPhpName('Clientintolerancemedicament');
        $this->setClassname('Webmis\\Models\\Clientintolerancemedicament');
        ...
        $this->addColumn('nameMedicament', 'Namemedicament', 'VARCHAR', true, 128, null);
...
} // ClientintolerancemedicamentTableMap
