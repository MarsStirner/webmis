...
/**
 * This class defines the structure of the 'OrgStructure_Stock' table.
 *
 *
 *
 ...
 */
class OrgstructureStockTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Webmis.Models.map.OrgstructureStockTableMap';
    ...
    {
        // attributes
        $this->setName('OrgStructure_Stock');
        $this->setPhpName('OrgstructureStock');
        $this->setClassname('Webmis\\Models\\OrgstructureStock');
        ...
        $this->addColumn('constrainedQnt', 'Constrainedqnt', 'DOUBLE', true, null, 0);
        $this->addColumn('orderQnt', 'Orderqnt', 'DOUBLE', true, null, 0);
        // validators
    } // initialize()
