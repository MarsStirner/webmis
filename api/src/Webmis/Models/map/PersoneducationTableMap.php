...
/**
 * This class defines the structure of the 'PersonEducation' table.
 *
 *
 *
 ...
 */
class PersoneducationTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Webmis.Models.map.PersoneducationTableMap';
    ...
    {
        // attributes
        $this->setName('PersonEducation');
        $this->setPhpName('Personeducation');
        $this->setClassname('Webmis\\Models\\Personeducation');
        ...
        $this->addColumn('origin', 'Origin', 'VARCHAR', true, 64, null);
