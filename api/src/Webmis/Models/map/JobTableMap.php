...
class JobTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Webmis.Models.map.JobTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setName('Job');
        $this->setPhpName('Job');
        $this->setClassname('Webmis\\Models\\Job');
        ...
        $this->addColumn('jobType_id', 'JobtypeId', 'INTEGER', true, null, null);
        $this->addColumn('orgStructure_id', 'OrgstructureId', 'INTEGER', true, null, null);
