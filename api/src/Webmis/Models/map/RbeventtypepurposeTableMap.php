...
class RbeventtypepurposeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Webmis.Models.map.RbeventtypepurposeTableMap';
    ...
    {
        $this->addRelation('Rbacheresult', 'Webmis\\Models\\Rbacheresult', RelationMap::ONE_TO_MANY, array('id' => 'eventPurpose_id', ), null, null, 'Rbacheresults');
    } // buildRelations()
