...
/**
 * This class defines the structure of the 'Quoting_Region' table.
 *
 *
 *
 ...
 */
class QuotingRegionTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Webmis.Models.map.QuotingRegionTableMap';
    ...
    {
        // attributes
        $this->setName('Quoting_Region');
        $this->setPhpName('QuotingRegion');
        $this->setClassname('Webmis\\Models\\QuotingRegion');
        ...
        $this->addColumn('region_code', 'RegionCode', 'VARCHAR', false, 13, null);
