...
class MkbQuotatypePacientmodelTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Webmis.Models.map.MkbQuotatypePacientmodelTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('MKB_id', 'MkbId', 'INTEGER', 'MKB', 'id', true, null, null);
    ...
    {
        $this->addRelation('Mkb', 'Webmis\\Models\\Mkb', RelationMap::MANY_TO_ONE, array('MKB_id' => 'id', ), null, null);
