...
/**
 * This class defines the structure of the 'PersonDocument' table.
 *
 *
 *
 ...
 */
class PersondocumentTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Webmis.Models.map.PersondocumentTableMap';
    ...
    {
        // attributes
        $this->setName('PersonDocument');
        $this->setPhpName('Persondocument');
        $this->setClassname('Webmis\\Models\\Persondocument');
