...
class RbhospitalbedprofileTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Webmis.Models.map.RbhospitalbedprofileTableMap';
    ...
    {
        $this->addRelation('RbhospitalbedprofileService', 'Webmis\\Models\\RbhospitalbedprofileService', RelationMap::ONE_TO_MANY, array('id' => 'rbHospitalBedProfile_id', ), null, null, 'RbhospitalbedprofileServices');
    } // buildRelations()
