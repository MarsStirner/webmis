...
/**
 * This class defines the structure of the 'PersonAddress' table.
 *
 *
 *
 ...
 */
class PersonaddressTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'Webmis.Models.map.PersonaddressTableMap';
    ...
    {
        // attributes
        $this->setName('PersonAddress');
        $this->setPhpName('Personaddress');
        $this->setClassname('Webmis\\Models\\Personaddress');
